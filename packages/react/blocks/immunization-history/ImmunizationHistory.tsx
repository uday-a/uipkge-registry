...
export function ImmunizationHistory({ className, ...props }: ImmunizationHistoryProps) {
  return (
    <div data-slot="immunization-history" className={cn('w-full space-y-6', className)} {...props}>
        ...
        <CardHeader className="border-border/60 bg-muted/20 border-b pb-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              <div className="flex size-9 shrink-0 items-center justify-center rounded-lg border border-emerald-500/30 bg-emerald-500/10 text-emerald-700 shadow-2xs dark:text-emerald-400">
                ...
                {protectionSummaries.map((chip) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex min-w-0 items-center gap-2">
                        <div className="flex size-7 shrink-0 items-center justify-center rounded-md border border-emerald-500/20 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400">
                    ...
                    <div className="border-border/60 text-muted-foreground mt-3 flex items-center justify-between border-t pt-2 text-xs">
                      ...
                      <span className="font-medium text-emerald-600 dark:text-emerald-400">{chip.status}</span>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <Card className="border-amber-500/30 bg-amber-500/[0.04] shadow-xs dark:bg-amber-500/[0.07]">
        <CardContent className="p-5 sm:p-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div className="flex items-start gap-3.5">
              <div className="flex size-9 shrink-0 items-center justify-center rounded-lg border border-amber-500/30 bg-amber-500/10 text-amber-700 shadow-2xs dark:text-amber-400">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  ...
                  <div className="bg-card/90 border-border/80 rounded-lg border p-3.5 shadow-2xs">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      <div className="flex items-center gap-1.5">
                        <Plane className="size-3.5 text-amber-600 dark:text-amber-400" aria-hidden="true" />
                        <span className="text-foreground text-xs font-semibold">Yellow Fever Vaccine (Live 17D)</span>
                      </div>
                      <Badge
                        wrap
                        variant="outline"
                        className="border-amber-500/30 text-xs text-amber-700 dark:text-amber-400"
                      >
                        Travel Advisory
                      </Badge>
                    </div>
                    ...
                    <div className="border-border/60 text-muted-foreground mt-2.5 flex items-center justify-between border-t pt-2 text-xs">
                      ...
                      <span className="font-medium text-amber-600 dark:text-amber-400">Pending Rx</span>
                    </div>
                  </div>
