...
export function ChatTwoPane() {
  ...
  const activeConvo = React.useMemo(() => conversations.find((c) => c.id === activeId)!, [conversations, activeId])
  ...
  return (
    <div
      ...
      className="bg-card text-card-foreground grid h-[680px] w-full grid-cols-[280px_1fr] overflow-hidden rounded-xl border shadow-sm"
    >
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center justify-between gap-1.5">
                  <p className={`truncate text-sm ${c.unread > 0 ? 'font-semibold' : 'font-medium'}`}>{c.name}</p>
                ...
                <div className="mt-0.5 flex items-center justify-between gap-1.5">
                  ...
                  <div className="flex shrink-0 items-center gap-1">
                    ...
                    {c.unread > 0 && (
                      <span className="bg-primary text-primary-foreground inline-flex h-4 min-w-4 items-center justify-center rounded-full px-1 text-xs font-bold tabular-nums">
                        {c.unread}
                      </span>
                    )}
                  </div>
