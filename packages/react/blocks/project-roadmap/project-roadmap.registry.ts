...
export default defineRegistryItem({
  ...
  files: [
    { path: 'ProjectRoadmap.tsx', target: 'components/blocks/project-roadmap/ProjectRoadmap.tsx' },
    { path: 'RoadmapMetrics.tsx', target: 'components/blocks/project-roadmap/RoadmapMetrics.tsx' },
    { path: 'RoadmapTaskDetail.tsx', target: 'components/blocks/project-roadmap/RoadmapTaskDetail.tsx' },
    { path: 'RoadmapAddTaskDialog.tsx', target: 'components/blocks/project-roadmap/RoadmapAddTaskDialog.tsx' },
