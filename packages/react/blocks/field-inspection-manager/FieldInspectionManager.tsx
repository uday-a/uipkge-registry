...
function renderThumbnailSvg(type: PhotoEvidence['previewType']) {
  switch (type) {
    case 'gauge':
      return (
...
export function FieldInspectionManager({ initialFilter = 'all', className }: FieldInspectionManagerProps) {
  ...
  }, [activeFilter, selectedFacility, searchQuery])
          ...
          <CardContent className="p-4 sm:p-5">
            ...
            <div className="mt-3">
              ...
              <div className="text-muted-foreground mt-1 flex items-center gap-1.5 text-xs">
                <span className="font-medium text-emerald-600 dark:text-emerald-400">24 Audits This Week</span>
                <span>·</span>
        ...
        <Card className="border-border shadow-xs">
          <CardContent className="p-4 sm:p-5">
            <div className="flex items-center justify-between">
              ...
              <div className="flex size-8 items-center justify-center rounded-md border border-rose-500/20 bg-rose-500/10 text-rose-600 dark:text-rose-400">
            ...
            <div className="mt-3">
              ...
              <div className="text-muted-foreground mt-1 flex items-center gap-1.5 text-xs">
                <span className="font-semibold text-rose-600 dark:text-rose-400">2 Critical Deficiencies</span>
                <span>·</span>
        ...
        <Card className="border-border shadow-xs">
          <CardContent className="p-4 sm:p-5">
            ...
            <div className="mt-3">
              ...
              <div className="text-muted-foreground mt-1 flex items-center gap-1.5 text-xs">
                <span className="font-medium text-emerald-600 dark:text-emerald-400">91.6% Pass Rate</span>
                <span>·</span>
          ...
          <CardContent className="p-4 sm:p-5">
            ...
            <div className="mt-3">
              ...
              <div className="text-muted-foreground mt-1 flex items-center gap-1.5 text-xs">
                ...
                <span>·</span>
                <span className="text-emerald-600 dark:text-emerald-400">-4m vs benchmark</span>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="flex flex-wrap items-center gap-2">
              <div className="relative min-w-[220px] flex-1 sm:w-64">
                ...
                <Input
                  ...
                  placeholder="Search asset, ID, facility..."
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/30">
                <TableHead className="min-w-[220px] text-xs font-semibold">Asset ID & Name</TableHead>
                <TableHead className="min-w-[200px] text-xs font-semibold">Facility Location</TableHead>
                <TableHead className="min-w-[200px] text-xs font-semibold">Inspection Date & GPS Geostamp</TableHead>
                <TableHead className="min-w-[160px] text-xs font-semibold">Checklist Score</TableHead>
                <TableHead className="min-w-[170px] text-xs font-semibold">Photo Evidence (2-3)</TableHead>
                <TableHead className="min-w-[170px] text-xs font-semibold">Inspector & Sign-off</TableHead>
                ...
                >
                  ...
                  <TableCell className="py-3.5 align-top">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className="text-foreground text-xs font-bold sm:text-sm">{{ ...record }.assetName}</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="border-border bg-muted/50 text-muted-foreground py-0.2 rounded border px-1.5 font-mono text-xs font-semibold">
                          {record.assetId}
                        </span>
                        <span className="text-muted-foreground text-xs">• {record.category}</span>
                      </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        >
                          ...
                          <span className="tabular-nums">{record.gps}</span>
                          {copiedGpsId === record.id ? (
                        ...
                        <span className="text-muted-foreground text-xs tabular-nums">({record.gpsAccuracy})</span>
                      </div>
                    </div>
                  </TableCell>
                  ...
                  <TableCell className="py-3.5 align-top">
                    <div className="space-y-1.5">
                      ...
                      <div className="text-muted-foreground text-xs tabular-nums">Duration: {record.duration}</div>
                    </div>
                  </TableCell>

                  {/* 5. Photo Evidence Thumbnail Gallery */}
                  <TableCell className="py-3.5 align-top">
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-1.5">
                        {record.photos.map((photo, pIdx) => (
                          <button
                            ...
                            onClick={() => setPreviewPhoto({ photo, record })}
                          >
                            {renderThumbnailSvg(photo.previewType)}
                  ...
                  <TableCell className="py-3.5 text-right align-top">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-48 text-xs">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem className="cursor-pointer gap-2" onClick={() => setSelectedAudit(record)}>
                          <Eye className="text-primary size-3.5" />
                          <span>View Audit Report</span>
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          className="cursor-pointer gap-2"
                          onClick={() => showToast(`Downloading certified PDF audit report for ${record.assetId}...`)}
                        >
            ...
            <>
                ...
                <div className="grid grid-cols-2 gap-2 text-xs sm:grid-cols-4">
                  ...
                  <div className="border-border bg-muted/30 rounded border p-2">
                    ...
                    <span className="text-foreground font-mono font-medium tabular-nums">
                      {previewPhoto.photo.time}
                    </span>
                  </div>
                  <div className="border-border bg-muted/30 rounded border p-2">
                    <span className="text-muted-foreground block text-xs">Cryptographic Seal</span>
                    <span className="font-mono font-medium text-emerald-600 dark:text-emerald-400">Valid SHA-256</span>
                  </div>
                </div>
              </div>
              ...
              <DialogFooter className="flex flex-wrap items-center justify-between gap-2">
                <Button
                  ...
                  onClick={() => showToast('Exporting high-resolution raw image file...')}
                >
          ...
          {selectedAudit && (
            <>
              ...
              <div className="space-y-5 py-2">
                ...
                {selectedAudit.status === 'critical' && (
                  <div className="space-y-1.5 rounded-lg border border-rose-500/30 bg-rose-500/10 p-3.5 text-xs text-rose-700 dark:text-rose-400">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {selectedAudit.photos.map((photo) => (
                      <button
                        key={photo.id}
                        type="button"
                        className="border-border hover:border-primary/60 group/p cursor-pointer overflow-hidden rounded-lg border bg-zinc-900 p-2 text-left transition-all"
                        onClick={() => setPreviewPhoto({ photo, record: selectedAudit })}
                      >
                        <div className="relative aspect-[16/10] w-full overflow-hidden rounded bg-black">
                          <div className="absolute inset-0 flex items-center justify-center">
                            <Camera className="size-6 text-zinc-500" />
                          </div>
                        </div>
              ...
              <DialogFooter className="flex flex-wrap items-center justify-between gap-2">
                <Button
                  ...
                  size="sm"
                  className="text-xs font-medium"
                  onClick={() => showToast(`Downloading certified PDF audit report for ${selectedAudit.assetId}...`)}
                >
                  <Download className="mr-1.5 size-3.5" />
                  Download PDF Report
                </Button>
            ...
            <div className="space-y-4 py-2">
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  <Select value={newAuditAsset} onValueChange={setNewAuditAsset}>
              ...
              <div className="space-y-1.5">
                ...
                <div
                  ...
                  onClick={() => showToast('Mock photo uploaded: asset_evidence_live.jpg')}
                >
                  <div className="flex flex-col items-center justify-center gap-1">
                    ...
                    <p className="text-muted-foreground text-xs">
                      Supports JPG, PNG up to 15MB with GPS EXIF retention
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                <label className="text-foreground text-xs font-semibold">
                  Inspector Observations & Checklist Notes
                </label>
                <Input
                  value={newAuditNotes}
