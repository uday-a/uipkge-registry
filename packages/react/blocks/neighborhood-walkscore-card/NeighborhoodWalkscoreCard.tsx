            ...
            <Map variant="dark" center={[-118.138, 34.145]} zoom={14.2} className="size-full">
              ...
              {filteredPois.map((poi) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="border-background bg-background flex size-7 items-center justify-center rounded-full border-2 shadow-md transition-transform hover:scale-125"
                      title={poi.name}
                    >
                      {poi.category === 'dining' ? (
