...
import { ArrowRight, Calendar, CheckCircle2, Lock, Mail, ShieldCheck, Sparkles, Zap } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 items-stretch gap-8 lg:grid-cols-12">
          ...
          <Card className="border-border bg-card/95 flex flex-col justify-between space-y-6 rounded-2xl p-6 text-left shadow-xl sm:p-8 lg:col-span-6">
            ...
            <div className="border-border text-muted-foreground flex items-center justify-between border-t pt-4 font-mono text-xs">
              ...
              <span className="font-semibold text-emerald-500">&check; 30-Min Fast Track</span>
            </div>
          </Card>
                  ...
                  <div className="grid grid-cols-4 gap-1.5">
                    {['1-10', '11-50', '50-200', '200+'].map((size) => (
                      <button
                        ...
                        type="button"
                        className={cn(
                          'rounded-lg border py-1.5 text-center font-mono text-xs transition-all',
                          teamSize === size
