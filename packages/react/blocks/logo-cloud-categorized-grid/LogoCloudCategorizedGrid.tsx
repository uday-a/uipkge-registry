...
import { ArrowRight, Brain, Building2, Cloud, Quote, ShieldCheck, Sparkles, Terminal, X } from 'lucide-react'
      ...
      <div className="mx-auto max-w-7xl space-y-12">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
          {filteredCustomers.map((customer) => (
            <Card
              key={customer.id}
              className="border-border bg-card/90 hover:border-primary/40 group flex cursor-pointer flex-col justify-between space-y-4 rounded-2xl p-5 shadow-sm transition-all hover:shadow-md"
