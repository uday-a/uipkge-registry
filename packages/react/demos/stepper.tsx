...
export default function StepperDemo() {
  ...
  return (
    <>
      ...
      >
        <Stepper value={step} onValueChange={setStep} steps={baseSteps} className="max-w-md" />
      </Story>
      ...
      >
        <Stepper value={2} steps={verticalSteps} orientation="vertical" className="max-w-xs" />
      </Story>
      ...
      >
        <div className="space-y-4">
          <Stepper value={wizardStep} onValueChange={setWizardStep} steps={wizardSteps} className="max-w-xl" />
          <div className="flex items-center gap-2">
            <Button variant="outline" size="sm" disabled={wizardStep === 1} onClick={() => setWizardStep((s) => s - 1)}>
              Prev
            </Button>
            <Button size="sm" disabled={wizardStep === wizardSteps.length} onClick={() => setWizardStep((s) => s + 1)}>
              Next
            </Button>
