...
import { IcicleChart } from '@react-registry/charts'
...
export default function IcicleChartDemo() {
  return (
    <>
      <Story title="Volume by trade lane" description="Top-down partition: region, then lane. Width is tonnage.">
        <IcicleChart data={volume} height={360} />
      </Story>
      <Story
        title="Capacity by alliance"
        description="Same shape for carrier splits — colour follows the top-level branch."
      >
        <IcicleChart data={capacity} height={360} />
      </Story>
    </>
  )
}
