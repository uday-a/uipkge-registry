...
} from '@react-registry-blocks/leaflet-neighborhood-walkscore-card/LeafletNeighborhoodWalkscoreCard'
...
export default function LeafletNeighborhoodWalkscoreCardDemo() {
  return (
    <>
      <Story
