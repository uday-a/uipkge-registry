...
import { Webhooks, type Endpoint } from '@react-registry-blocks/webhooks/Webhooks'

const failingEndpoints: Endpoint[] = [
  {
    id: 'e1',
...
export default function WebhooksDemo() {
  return (
    <>
      ...
      <Story title="Mixed statuses" description="A realistic log mixing successes, client errors and server failures.">
        <Webhooks
          deliveries={[
            {
              id: 'd1',
      ...
      <Story
        title="Latency formatting"
        description="Sub-second shows ms; longer attempts show seconds with one decimal."
      >
        <Webhooks
          deliveries={[
            {
