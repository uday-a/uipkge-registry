      ...
      <Story title="Side by side" description="Multiple independent pickers driving distinct theme tokens.">
        <div className="grid gap-6 sm:grid-cols-3">
          <div className="space-y-2">
            ...
            <div className="h-8 rounded-md border" style={{ backgroundColor: primary }} />
          </div>
          <div className="space-y-2">
            <p className="text-sm font-medium">Accent</p>
            <ColorPicker value={accent} onValueChange={setAccent} />
            <div className="h-8 rounded-md border" style={{ backgroundColor: accent }} />
          </div>
          <div className="space-y-2">
            <p className="text-sm font-medium">Surface</p>
            <ColorPicker value={surface} onValueChange={setSurface} />
            <div className="h-8 rounded-md border" style={{ backgroundColor: surface }} />
          </div>
        </div>
      </Story>
      ...
      >
        <div className="bg-card text-card-foreground max-w-sm space-y-3 rounded-lg border p-4">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground text-xs">Used on primary buttons, links, and active tabs.</p>
          </div>
          <ColorPicker value={brand} onValueChange={setBrand} />
          <div className="flex items-center gap-2 rounded-md border px-3 py-2 text-sm">
            <span className="size-4 rounded" style={{ backgroundColor: brand }} />
            <span>
