...
export default function LineChartDemo() {
  return (
    <>
      ...
      >
        <LineChart data={traffic} xField="day" yField={['sessions', 'signups']} height="300" />
      </Story>
      ...
      >
        <LineChart data={traffic} xField="day" yField={['sessions', 'signups']} option={smoothOption} height="300" />
      </Story>
      ...
      >
        <LineChart data={traffic} xField="day" yField={['sessions', 'signups']} option={dashedOption} height="300" />
      </Story>
      ...
      >
        <LineChart data={traffic} xField="day" yField="sessions" option={steppedOption} height="280" />
      </Story>
      ...
      >
        <LineChart data={traffic} xField="day" yField="sessions" option={markersOption} height="280" />
      </Story>

      <Story title="Linear curves" description="Straight segments via the curve prop — no option override needed.">
        <LineChart data={traffic} xField="day" yField={['sessions', 'signups']} curve="linear" height="300" />
      </Story>
      ...
      >
        <LineChart data={traffic} xField="day" yField="sessions" curve="stepStart" height="280" />
      </Story>

      <Story title="Stacked lines" description="Cumulative stacking as a first-class prop.">
        <LineChart data={traffic} xField="day" yField={['sessions', 'signups']} stacked height="300" />
      </Story>

      <Story title="Dashed forecast" description="Dashed stroke plus hidden markers reads as projection.">
        <LineChart data={traffic} xField="day" yField="sessions" dashed markers={false} height="280" />
      </Story>
      ...
      >
        <LineChart data={cargoDemand} xField="m" yField={['flown', 'forecast']} option={peakOption} height="320" />
      </Story>
      ...
      >
        <LineChart data={spotRates} xField="m" yField="tpeb" option={cnyOption} height="300" />
      </Story>
      ...
      >
        <LineChart data={spotRates} xField="m" yField="fewb" option={changeOption} height="300" />
      </Story>
    </>
  )
}
