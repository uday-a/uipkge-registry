              ...
              <KanbanColumn key={column.id} id={column.id} label={column.label}>
                ...
                <KanbanColumnBody>
                  ...
                  {column.cards.length === 0 && (
                    <KanbanColumnEmpty>Drop a card here</KanbanColumnEmpty>
                  )}
                </KanbanColumnBody>
              </KanbanColumn>
            ))}
                ...
                <KanbanColumnBody>
                  {column.cards.map((card) => (
                    ...
                    >
                      ...
                      {card.id === "m-2" && (
                        <KanbanCardDescription>
                          Locked by a workflow rule
                        </KanbanCardDescription>
                      )}
                    </KanbanCard>
                  ))}
                  {column.cards.length === 0 && (
                    <KanbanColumnEmpty>Empty</KanbanColumnEmpty>
                  )}
                </KanbanColumnBody>
              </KanbanColumn>
            ))}
          ...
          <KanbanBoard>
            {compact.board.map((column) => (
              <KanbanColumn
                ...
                id={column.id}
                label={column.label}
                className="min-h-[180px] w-56 p-2"
              >
                <KanbanColumnHeader>
                ...
                <KanbanColumnBody>
                  {column.cards.map((card) => (
                    <KanbanCard
                      ...
                      className="gap-0 p-2"
                    >
                      <KanbanCardTitle className="text-xs">
                        {card.title}
                      </KanbanCardTitle>
                    </KanbanCard>
                  ))}
