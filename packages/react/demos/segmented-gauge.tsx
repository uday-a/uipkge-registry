...
export default function SegmentedGaugeDemo() {
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-sm">
          <SegmentedGauge segments={browsers}>
            <p className="text-3xl font-bold tracking-tight tabular-nums">1,735</p>
      ...
      >
        <div className="mx-auto max-w-sm">
          <SegmentedGauge segments={regions}>
            <p className="text-3xl font-bold tracking-tight tabular-nums">12.4k</p>
      ...
      >
        <div className="mx-auto max-w-sm">
          <SegmentedGauge segments={sentiment}>
            <p className="text-3xl font-bold tracking-tight tabular-nums">72%</p>
      ...
      >
        <div className="mx-auto max-w-sm">
          <SegmentedGauge segments={splitFifty} stroke={28} showTrack={false} gap={6} />
        </div>
      </Story>
