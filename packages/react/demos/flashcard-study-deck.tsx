...
import { FlashcardStudyDeck, type Flashcard } from '@react-registry-blocks/flashcard-study-deck/FlashcardStudyDeck'
...
export default function FlashcardStudyDeckDemo() {
  return (
    <>
      <Story
        title="Default"
      ...
      >
        <FlashcardStudyDeck initialTitle="Frontend Architecture & TypeScript Mastery" initialCards={frontendCards} />
      </Story>
    </>
  )
}
