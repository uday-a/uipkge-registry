...
import { UptimeTrackerChart, type StatusDay } from '@react-registry/charts'
...
export default function UptimeTrackerChartDemo() {
  return (
    <>
      <Story title="Healthy quarter" description="90 daily bars; uptime % computes from the data.">
        <UptimeTrackerChart days={healthy} />
      </Story>
      <Story title="With incidents" description="Degraded stretches and a full outage day. Hover any bar for its date.">
