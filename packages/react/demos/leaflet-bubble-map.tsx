...
export default function LeafletBubbleMapDemo() {
  return (
    <Story
    ...
    >
      ...
      >
        ...
        <div className="border-border bg-card/95 absolute top-3 left-3 z-[1000] rounded-lg border px-3 py-2 shadow-sm backdrop-blur-sm">
          <p className="text-foreground text-xs font-semibold">Edge requests / day</p>
          <p className="text-muted-foreground mt-0.5 font-mono text-[10px]">bubble area ∝ volume (M)</p>
        </div>
      </LeafletMap>
    </Story>
  )
