      ...
      >
        <Card className="max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              Use this key in your server-side code. Keep it secret.
            </CardDescription>
          </CardHeader>
        ...
        <div className="max-w-md space-y-3">
          <div className="bg-muted flex items-center justify-between rounded-md p-3">
            <code className="text-sm">
              git clone https://github.com/uday-a/next-boilerplate.git
            </code>
            <Clipboard
              text="git clone https://github.com/uday-a/next-boilerplate.git"
              onCopy={onCopy}
            />
          </div>
          <div className="bg-muted flex items-center justify-between rounded-md p-3">
            ...
            <Clipboard
              text="VITE_API_URL=https://api.example.com"
              onCopy={onCopy}
            />
          </div>
        </div>
