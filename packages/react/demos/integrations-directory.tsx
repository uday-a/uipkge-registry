...
import {
  ...
  type Integration,
} from '@react-registry-blocks/integrations-directory/IntegrationsDirectory'

const manyIntegrations: Integration[] = [
  {
    id: 'pulseboard',
    name: 'Pulseboard',
...
export default function IntegrationsDirectoryDemo() {
  return (
    <>
      <Story
        title="Default"
        description="Marketplace grid with functional search, category chips and an installed filter."
      >
        <IntegrationsDirectory />
      </Story>
