...
export default function RichTextEditorDemo() {
  ...
  const [tall, setTall] = useState('<p>This editor has a taller minimum height for longer-form writing.</p>')
  ...
  return (
    <>
      ...
      >
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-xs">
            Length: <code className="text-foreground">{empty.length}</code> chars
          </p>
        </div>
      </Story>
      ...
      >
        <RichTextEditor value={filled} onValueChange={setFilled} minHeight="150px" />
      </Story>

      <Story title="Custom min-height" description="Taller editor surface for long-form content.">
        <RichTextEditor value={tall} onValueChange={setTall} placeholder="Draft your post..." minHeight="280px" />
      </Story>
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-1">
            ...
            <RichTextEditor value={left} onValueChange={setLeft} placeholder="Source..." minHeight="160px" />
          </div>
          <div className="space-y-1">
            <p className="text-sm font-medium">Japanese</p>
            <RichTextEditor value={right} onValueChange={setRight} placeholder="Translation..." minHeight="160px" />
          </div>
        </div>
      </Story>
    </>
