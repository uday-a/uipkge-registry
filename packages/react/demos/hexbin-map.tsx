  ...
  return (
    <>
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-2 text-xs">
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              ...
              <span className="text-foreground font-medium">Selected State:</span>
              <span>{selected1 || 'None (Click a hex)'}</span>
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">National Average:</span> 74.8%
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">Top Tier:</span> VA (96.0%), DC (98.4%)
            </div>
          </div>
      ...
      >
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-2 text-xs">
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="inline-block h-2 w-2 rounded-full bg-emerald-500" />
              <span className="text-foreground font-medium">&lt; 30ms:</span> Optimal
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="inline-block h-2 w-2 rounded-full bg-amber-500" />
              <span className="text-foreground font-medium">30-60ms:</span> Normal
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="inline-block h-2 w-2 rounded-full bg-red-500" />
              <span className="text-foreground font-medium">&gt; 60ms:</span> Extended
            </div>
          </div>
      ...
      >
        <div className="space-y-4">
          <div className="border-border bg-card rounded-xl border p-4">
            <HexbinMap shape="square" data={adoptionData} showValues={true} valueFormatter={(v) => `${v}%`} />
          </div>
        </div>
      </Story>
