      ...
      >
        <Timeline direction="horizontal" className="w-full overflow-x-auto py-2">
          {ship.map((step) => {
            ...
            return (
              <TimelineItem key={step.id} status={step.status} className="min-w-36">
                <TimelineMedia variant="icon">
                  <Icon />
                </TimelineMedia>
                <TimelineContent>
                  <TimelineTitle className="text-xs font-semibold">{step.title}</TimelineTitle>
            ...
            <TimelineItem key={m.id}>
              <TimelineMedia variant="avatar">
                <Avatar className="size-8">
                  <AvatarFallback className="text-xs font-medium">{m.initials}</AvatarFallback>
                </Avatar>
              </TimelineMedia>
              <TimelineContent>
                <TimelineHeader>
            ...
            <TimelineContent>
              ...
              <Card className="mt-2">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium">Core Enhancements</CardTitle>
                </CardHeader>
