...
export default function AttachmentDemo() {
  return (
    <>
      ...
      <Story title="Removable" description="removable adds a close control. Listen for onRemove.">
      ...
      <Story title="Long title" description="Overflow truncates inside the chip.">
        <Attachment
          className="max-w-xs"
