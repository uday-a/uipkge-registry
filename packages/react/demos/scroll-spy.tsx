...
import { ScrollSpy, type ScrollSpyItem as ScrollSpyItemType } from '@react-registry/scroll-spy'
          ...
          >
            <section id="react-demo-installation" className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-foreground text-base font-semibold tracking-tight">Installation</h3>
              </div>
              ...
              <p className="text-muted-foreground text-xs leading-relaxed">
                This automatically installs all compound primitives: <code>ScrollSpy</code>, <code>ScrollSpyTitle</code>
                , <code>ScrollSpyList</code>, <code>ScrollSpyItem</code>, <code>ScrollSpyLink</code>, and{' '}
                <code>ScrollSpyIndicator</code>.
              </p>
            </section>

            <section id="react-demo-examples" className="border-border/40 space-y-4 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  02
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Examples</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              >
                <div className="flex items-center justify-between">
                  <h4 className="text-foreground text-sm font-semibold">Variants</h4>
                  <span className="text-muted-foreground font-mono text-xs">variant="line | angle"</span>
                </div>
                <p className="text-muted-foreground text-xs leading-relaxed">
                ...
                <div className="grid grid-cols-2 gap-2 pt-1 text-xs">
                  <div className="border-border/40 bg-muted/30 rounded p-2.5">
                    ...
                    <div className="text-muted-foreground text-xs">Clean, straight border tracking</div>
                  </div>
                  <div className="border-border/40 bg-muted/30 rounded p-2.5">
                    <div className="text-foreground font-medium">Circuit Rail</div>
                    <div className="text-muted-foreground text-xs">Seamless S-curves for sub-levels</div>
                  </div>
                </div>
              </div>

              <div id="react-demo-sizes" className="border-border/50 bg-background/60 space-y-2 rounded-lg border p-4">
                <div className="flex items-center justify-between">
                  <h4 className="text-foreground text-sm font-semibold">Sizes &amp; Depth</h4>
                  <span className="text-muted-foreground font-mono text-xs">depth 1 – 4</span>
                </div>
                <p className="text-muted-foreground text-xs leading-relaxed">
                  Child headings nested under an <code>ScrollSpyItem</code> automatically receive optical indentation:
                  12px for level 2, 24px for level 3, and 36px for level 4. The indicator tracks each link's exact
                  coordinates.
                </p>
              </div>

              <div id="react-demo-states" className="border-border/50 bg-background/60 space-y-2 rounded-lg border p-4">
                <div className="flex items-center justify-between">
                  <h4 className="text-foreground text-sm font-semibold">States &amp; Interaction</h4>
                  <span className="text-muted-foreground font-mono text-xs">scroll-spy</span>
                </div>
                <p className="text-muted-foreground text-xs leading-relaxed">
                  The active link illuminates as headings enter the viewport threshold. Clicking any link initiates an
                  animated smooth scroll with customizable offset margins.
                </p>
              </div>
            </section>

            <section id="react-demo-props" className="border-border/40 space-y-3 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  03
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Props</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Configure target containers, scrolling offsets, and visual positioning with reactive props.
              </p>
              <div className="divide-border/40 border-border/50 bg-background/60 divide-y rounded-lg border text-xs">
                <div className="flex items-start justify-between p-3">
                  <div>
                    <div className="text-foreground font-mono font-medium">items</div>
                    <div className="text-muted-foreground">Hierarchical array of navigation items</div>
                  </div>
                  <span className="text-muted-foreground font-mono">ScrollSpyItem[]</span>
                </div>
                <div className="flex items-start justify-between p-3">
                  <div>
                    <div className="text-foreground font-mono font-medium">scrollContainer</div>
                    <div className="text-muted-foreground">CSS selector or element for local overflow scrolling</div>
                  </div>
                  <span className="text-muted-foreground font-mono">string | HTMLElement</span>
                </div>
                <div className="flex items-start justify-between p-3">
                  <div>
                    <div className="text-foreground font-mono font-medium">offsetTop</div>
                    <div className="text-muted-foreground">Pixel offset when measuring heading boundaries</div>
                  </div>
                  <span className="text-muted-foreground font-mono">number (default: 0)</span>
                </div>
              </div>
            </section>

            <section id="react-demo-dependencies" className="border-border/40 space-y-3 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  04
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Dependencies</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="border-border/50 bg-muted/20 text-muted-foreground flex items-center justify-between rounded-lg border p-3 text-xs">
                ...
                <span className="text-foreground font-mono font-semibold">0 external npm packages</span>
              </div>
            </section>

            <section id="react-demo-files" className="border-border/40 space-y-3 border-t pt-6 pb-12">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  05
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Files</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Modular architecture split into focused single-responsibility primitives:
              </p>
              <div className="grid grid-cols-2 gap-2 font-mono text-xs">
                <div className="border-border/40 bg-muted/30 text-foreground/80 rounded p-2">scroll-spy.tsx</div>
                <div className="border-border/40 bg-muted/30 text-foreground/80 rounded p-2">index.ts</div>
          ...
          <div className="flex flex-col gap-3 py-2 pl-2">
            <div className="border-border/50 flex flex-col gap-2 border-b pb-2 text-xs">
              ...
              <div className="flex flex-wrap items-center gap-1 pt-0.5">
                ...
                {['primary', 'foreground', 'destructive', '#f59e0b'].map((c) => (
                  <button
                    key={c}
                    type="button"
          ...
          >
            <section id="react-left-intro" className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-foreground text-base font-semibold tracking-tight">Introduction</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="border-border/50 bg-background/60 text-muted-foreground rounded-lg border p-3.5 text-xs">
                <strong className="text-foreground mb-1 block">Layout Flexibility</strong>
                Supports inverted rail alignments without altering document markup or DOM tab order.
              </div>
            </section>

            <section id="react-left-arch" className="border-border/40 space-y-4 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  02
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Architecture</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div id="react-left-tokens" className="border-border/50 bg-background/60 space-y-2 rounded-lg border p-4">
                <h4 className="text-foreground text-sm font-semibold">Design Tokens</h4>
                <p className="text-muted-foreground text-xs leading-relaxed">
              ...
              <div
                ...
                className="border-border/50 bg-background/60 space-y-2 rounded-lg border p-4"
              >
                <h4 className="text-foreground text-sm font-semibold">Spacing Rhythm</h4>
                <p className="text-muted-foreground text-xs leading-relaxed">
            ...
            <section id="react-left-api" className="border-border/40 space-y-3 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  03
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">API Specs</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <section id="react-left-faq" className="border-border/40 space-y-3 border-t pt-6 pb-12">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  04
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">FAQ &amp; Troubleshooting</h3>
              </div>
              <div className="space-y-3">
                <div className="border-border/50 bg-background/60 space-y-1 rounded-lg border p-3.5">
                  <h5 className="text-foreground text-xs font-semibold">Can I use ScrollSpy with window scroll?</h5>
                  <p className="text-muted-foreground text-xs leading-relaxed">
          ...
          >
            <section id="react-angle-installation" className="space-y-3">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                ...
                <code>variant="angle"</code> to activate SVG vector path rendering.
              </p>
              <div className="border-border/50 bg-muted/60 text-foreground/90 rounded-md border px-3.5 py-2.5 font-mono text-xs">
            ...
            <section id="react-angle-examples" className="border-border/40 space-y-4 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  02
                </span>
              ...
              <div
                ...
                className="border-border/50 bg-background/60 space-y-2 rounded-lg border p-4"
              >
                <h4 className="text-foreground text-sm font-semibold">Tangent-Continuous Geometry</h4>
                <p className="text-muted-foreground text-xs leading-relaxed">
              ...
              <div id="react-angle-sizes" className="border-border/50 bg-background/60 space-y-2 rounded-lg border p-4">
                <h4 className="text-foreground text-sm font-semibold">Depth Tracking</h4>
                <p className="text-muted-foreground text-xs leading-relaxed">
              ...
              <div
                ...
                className="border-border/50 bg-background/60 space-y-2 rounded-lg border p-4"
              >
                <h4 className="text-foreground text-sm font-semibold">Optical Alignment</h4>
                <p className="text-muted-foreground text-xs leading-relaxed">
            ...
            <section id="react-angle-props" className="border-border/40 space-y-3 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  03
                </span>
              ...
              <div className="divide-border/40 border-border/50 bg-background/60 divide-y rounded-lg border text-xs">
                <div className="flex items-start justify-between p-3">
                  <div>
                    <div className="text-foreground font-mono font-medium">turn="rounded"</div>
                    <div className="text-muted-foreground">Smooth cubic bezier S-curve transitions (default)</div>
                  </div>
                  <span className="text-muted-foreground font-mono">default</span>
                </div>
                <div className="flex items-start justify-between p-3">
                  <div>
                    <div className="text-foreground font-mono font-medium">turn="angle"</div>
                    <div className="text-muted-foreground">Geometric 45-degree chamfered bends</div>
                  </div>
                  <span className="text-muted-foreground font-mono">optional</span>
                </div>
              </div>
            </section>

            <section id="react-angle-dependencies" className="border-border/40 space-y-3 border-t pt-6 pb-12">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  04
                </span>
          ...
          >
            <section id="react-top-step-1" className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-foreground text-base font-semibold tracking-tight">Step 1: Account Setup</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div className="border-border/50 bg-background/60 space-y-1 rounded-lg border p-3.5">
                  <label className="text-foreground text-xs font-medium">Organization Slug</label>
                  <div className="border-border/40 bg-muted/40 text-muted-foreground rounded px-2.5 py-1.5 font-mono text-xs">
                    acme-corp
                  </div>
                </div>
                <div className="border-border/50 bg-background/60 space-y-1 rounded-lg border p-3.5">
                  <label className="text-foreground text-xs font-medium">Billing Contact</label>
                  <div className="border-border/40 bg-muted/40 text-muted-foreground rounded px-2.5 py-1.5 font-mono text-xs">
                    billing@acme.com
                  </div>
                </div>
            ...
            <section id="react-top-step-2" className="border-border/40 space-y-4 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary text-primary-foreground flex h-5 w-5 items-center justify-center rounded-full font-mono text-xs font-semibold">
                  2
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Step 2: Profile Details</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="border-border/50 bg-background/60 space-y-3 rounded-lg border p-4">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-foreground font-medium">Single Sign-On (SAML / OIDC)</span>
                  <span className="text-primary font-mono font-medium">Enabled</span>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span className="text-foreground font-medium">Enforce Multi-Factor Authentication</span>
                  <span className="text-primary font-mono font-medium">Required</span>
                </div>
              </div>
            </section>

            <section id="react-top-step-3" className="border-border/40 space-y-4 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary text-primary-foreground flex h-5 w-5 items-center justify-center rounded-full font-mono text-xs font-semibold">
                  3
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Step 3: Preferences</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="border-border/50 bg-background/60 rounded-lg border p-3 text-center">
                  <div className="text-foreground text-xs font-semibold">Slack</div>
                  <div className="text-muted-foreground text-[11px]">Instant alerts</div>
                </div>
                <div className="border-border/50 bg-background/60 rounded-lg border p-3 text-center">
                  <div className="text-foreground text-xs font-semibold">Email</div>
                  <div className="text-muted-foreground text-[11px]">Daily digest</div>
                </div>
                <div className="border-border/50 bg-background/60 rounded-lg border p-3 text-center">
                  <div className="text-foreground text-xs font-semibold">Webhooks</div>
                  <div className="text-muted-foreground text-[11px]">Raw JSON payload</div>
                </div>
              </div>
            </section>

            <section id="react-top-step-4" className="border-border/40 space-y-4 border-t pt-6 pb-12">
              <div className="flex items-center gap-2">
                <span className="bg-primary text-primary-foreground flex h-5 w-5 items-center justify-center rounded-full font-mono text-xs font-semibold">
                  4
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Step 4: Review &amp; Launch</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="border-border/50 bg-muted/30 text-muted-foreground flex items-center justify-between rounded-lg border p-4 text-xs">
                ...
                <span className="text-primary font-semibold">All policies validated</span>
              </div>
            </section>
          </div>
        </div>
          ...
          >
            <section id="react-top-spy-overview" className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-foreground text-base font-semibold tracking-tight">Overview</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="border-border/50 bg-background/60 text-muted-foreground rounded-lg border p-3.5 text-xs">
                <strong className="text-foreground mb-1 block">Active Section Only</strong>
            ...
            <section id="react-top-spy-features" className="border-border/40 space-y-4 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  02
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Features</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div className="border-border/50 bg-background/60 space-y-1 rounded-lg border p-3.5">
                  <h4 className="text-foreground text-xs font-semibold">Active Indicator Dot</h4>
                  <p className="text-muted-foreground text-xs leading-relaxed">
                    An illuminated micro-dot indicates the current active item with smooth spring transitions.
                  </p>
                </div>
                <div className="border-border/50 bg-background/60 space-y-1 rounded-lg border p-3.5">
                  <h4 className="text-foreground text-xs font-semibold">Reading Progress Track</h4>
                  <p className="text-muted-foreground text-xs leading-relaxed">
            ...
            <section id="react-top-spy-specs" className="border-border/40 space-y-4 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  03
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Specifications</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <section id="react-top-spy-faq" className="border-border/40 space-y-3 border-t pt-6 pb-12">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  04
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">FAQ</h3>
              </div>
              <div className="space-y-3">
                <div className="border-border/50 bg-background/60 space-y-1 rounded-lg border p-3.5">
                  <h5 className="text-foreground text-xs font-semibold">
                ...
                <div className="border-border/50 bg-background/60 space-y-1 rounded-lg border p-3.5">
                  <h5 className="text-foreground text-xs font-semibold">Does it support keyboard navigation?</h5>
                  <p className="text-muted-foreground text-xs leading-relaxed">
          ...
          >
            <section id="react-bot-sec-1" className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-foreground text-base font-semibold tracking-tight">Introduction &amp; Mission</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <section id="react-bot-sec-2" className="border-border/40 space-y-3 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  2
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Core Primitives</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="border-border/50 bg-background/60 space-y-2 rounded-lg border p-4">
                <h4 className="text-foreground text-xs font-semibold">Capsule Controls</h4>
                <p className="text-muted-foreground text-xs leading-relaxed">
            ...
            <section id="react-bot-sec-3" className="border-border/40 space-y-3 border-t pt-6">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  3
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Design Engineering</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="border-border/40 bg-muted/30 rounded-lg p-3">
                  <div className="text-foreground font-medium">Spring Motion</div>
                  <div className="text-muted-foreground text-xs">Fluid state transitions</div>
                </div>
                <div className="border-border/40 bg-muted/30 rounded-lg p-3">
                  <div className="text-foreground font-medium">Subtle Layering</div>
                  <div className="text-muted-foreground text-xs">Surface elevation with 1px border</div>
                </div>
              </div>
            </section>

            <section id="react-bot-sec-4" className="border-border/40 space-y-3 border-t pt-6 pb-12">
              <div className="flex items-center gap-2">
                <span className="bg-primary/10 text-primary rounded px-1.5 py-0.5 font-mono text-xs font-medium">
                  4
                </span>
                <h3 className="text-foreground text-base font-semibold tracking-tight">Production Ready</h3>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="border-border/50 bg-muted/40 text-foreground/90 flex items-center justify-between rounded-lg border p-3.5 text-xs">
                ...
                <span className="text-primary font-semibold">100% Tested &amp; Verified</span>
              </div>
            </section>
          </div>
