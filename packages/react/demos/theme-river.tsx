...
import { ThemeRiver } from "@react-registry/charts";
...
for (const s of Object.keys(sentimentSeries) as Array<
  keyof typeof sentimentSeries
>) {
...
export default function ThemeRiverDemo() {
  return (
    <>
      <Story
