  ...
  return (
    <>
      ...
      <Story title="Custom colors" description="valueColor and rangeColor accept any CSS color or var.">
        <div className="flex items-center gap-6">
          <Knob value={v4} onValueChange={setV4} valueColor="var(--chart-1)" rangeColor="var(--muted)" />
          <Knob value={v4} onValueChange={setV4} valueColor="var(--destructive)" />
        </div>
      </Story>
      ...
      <Story title="Custom value template" description="Override the centered text via the value slot.">
        <div className="flex items-center gap-6">
          <Knob value={v6} onValueChange={setV6} renderValue={(value) => <tspan>{value}%</tspan>} />
        </div>
      </Story>
    </>
  )
