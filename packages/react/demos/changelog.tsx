...
import { Changelog, type Release } from '@react-registry-blocks/changelog/Changelog'

const breakingReleases: Release[] = [
  {
    version: 'v3.0.0',
    date: '2026-08-20',
    entries: [
...
const manyReleases: Release[] = Array.from({ length: 8 }, (_, i) => ({
  version: `v2.${7 - i}.0`,
...
const longDescriptions: Release[] = [
  {
    version: 'v2.4.1',
    date: '2026-08-18',
    entries: [
  ...
  return (
    <>
      ...
      <Story
        ...
        description="Multi-line descriptions keep the rail aligned via in-flow dot markers."
      >
      ...
      <Story title="Subscribe emphasis" description="The Subscribe action promoted to the filled primary variant.">
        <Changelog subscribeVariant="default" />
      </Story>
