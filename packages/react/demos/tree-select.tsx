...
export default function TreeSelectDemo() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-md space-y-2">
          <TreeSelect
            ...
            className="w-full"
          />
          <p className="text-muted-foreground text-xs">Selected: {fileValue ?? 'none'}</p>
        </div>
      </Story>
      ...
      >
        <div className="max-w-md space-y-2">
          <TreeSelect
            ...
            className="w-full"
          />
          <p className="text-muted-foreground text-xs">{multiValue.length} file(s) selected</p>
        </div>
      </Story>

      <Story title="Size variants" description="Small, default, and large triggers side by side for comparison.">
        <div className="max-w-md space-y-3">
          <TreeSelect
            ...
            className="w-full"
          />
          <TreeSelect data={fileTree} placeholder="Default..." className="w-full" />
          <TreeSelect
            value={lgValue}
      ...
      <Story title="Loading & disabled states" description="Spinner while data loads, and a fully disabled control.">
        <div className="max-w-md space-y-3">
          <TreeSelect data={fileTree} loading placeholder="Loading files..." className="w-full" />
          <TreeSelect data={fileTree} disabled placeholder="Disabled" className="w-full" />
        </div>
      </Story>
      ...
      >
        <div className="max-w-md">
          <TreeSelect data={restrictedTree} placeholder="Select a file..." className="w-full" />
        </div>
      </Story>
      ...
      >
        <Card className="max-w-md">
          <CardHeader>
            ...
            <CardDescription>Choose which teams can collaborate on this repository.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="text-muted-foreground flex items-center justify-between text-xs">
              ...
              <span className="text-foreground font-medium">{orgValue.join(', ') || 'No access'}</span>
            </div>
          </CardContent>
        </Card>
      </Story>
