...
import { DnsRecordManager, type DnsRecord } from '@react-registry-blocks/dns-record-manager/DnsRecordManager'
...
export default function DnsRecordManagerDemo() {
  return (
    <>
      <Story
        title="Default"
      ...
      >
        <DnsRecordManager initialAddOpen />
      </Story>
      ...
      >
        <DnsRecordManager domain="mail.uipkge.dev" initialRecords={emailRecords} />
      </Story>
