...
export default function DatePickerDemo() {
  ...
  const customPresets = [
    ...
    {
      label: "Last 7 Days",
      value: { start: addDays(todayD, -6), end: todayD },
    },
    {
      label: "Last 30 Days",
      value: { start: addDays(todayD, -29), end: todayD },
    },
