...
import { ScatterChart } from '@react-registry/charts'
  ...
  series: [
    {
      markLine: {
        ...
        label: { formatter: 'Trend', position: 'insideEndTop' as const, color: '#64748b' },
...
export default function ScatterChartDemo() {
  return (
    <>
      <Story title="Basic scatter" description="Plain XY scatter — pass `x-field` and `y-field` and that's it.">
        <ScatterChart data={basic} xField="x" yField="y" height="320" />
      </Story>
      ...
      >
        <ScatterChart data={bubble} xField="x" yField="y" sizeField="size" height="320" />
      </Story>
      ...
      >
        <ScatterChart data={categorical} xField="x" yField="y" categoryField="category" height="320" />
      </Story>
      ...
      >
        <ScatterChart data={basic} xField="x" yField="y" option={trendLineOption} height="320" />
      </Story>
      ...
      >
        <ScatterChart data={lanes} xField="days" yField="rate" sizeField="tonnes" categoryField="region" height="340" />
      </Story>
    </>
  )
}
