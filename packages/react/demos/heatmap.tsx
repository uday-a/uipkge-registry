...
export default function HeatmapDemo() {
  return (
    <>
      ...
      >
        <Heatmap data={usageData} xLabels={xLabels} yLabels={yLabels} height="320" />
      </Story>
      ...
      >
        <Heatmap data={sparse} xLabels={xLabels} yLabels={yLabels} option={gapsOption} height="320" />
      </Story>
      ...
      >
        <Heatmap data={usageData} xLabels={xLabels} yLabels={yLabels} option={tealRampOption} height="320" />
      </Story>
      ...
      >
        <Heatmap data={usageData} xLabels={xLabels} yLabels={yLabels} option={orangeRampOption} height="320" />
      </Story>
