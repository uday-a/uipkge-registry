    ...
    <>
      <Story title="Phone" description="US phone format: (###) ###-####">
        <div className="max-w-sm">
          ...
          <MaskedInput value={phone} onValueChange={setPhone} mask="(###) ###-####" className="mt-1.5" />
      ...
      <Story title="Date" description="Date format: ##/##/####">
        <div className="max-w-sm">
          ...
          <MaskedInput value={date} onValueChange={setDate} mask="##/##/####" placeholderChar="0" className="mt-1.5" />
          <p className="text-muted-foreground mt-1 text-xs">
      ...
      <Story title="SSN" description="Social Security format: ###-##-####">
        <div className="max-w-sm">
          <Label>SSN</Label>
          <MaskedInput value={ssn} onValueChange={setSsn} mask="###-##-####" className="mt-1.5" />
          <p className="text-muted-foreground mt-1 text-xs">
      ...
      <Story title="Credit Card" description="Card format: #### #### #### ####">
        <div className="max-w-sm">
          ...
          <MaskedInput value={card} onValueChange={setCard} mask="#### #### #### ####" className="mt-1.5" />
          <p className="text-muted-foreground mt-1 text-xs">
      ...
      <Story title="Custom Pattern" description="License plate format: AAA-####">
        <div className="max-w-sm">
          ...
          <MaskedInput value={custom} onValueChange={setCustom} mask="AAA-####" replacement="A" className="mt-1.5" />
          <p className="text-muted-foreground mt-1 text-xs">
      ...
      <Story title="Completed Event" description="Emits 'complete' when the mask is fully filled.">
        <div className="max-w-sm">
          ...
          <MaskedInput
            ...
            className="mt-1.5"
          />
          <p className="text-muted-foreground mt-1 text-xs">Type 6 digits to trigger complete event</p>
        </div>
      </Story>
      ...
      >
        <div className="max-w-sm">
          ...
          <MaskedInput mask="(###) ###-####" placeholder="(555) 000-0000" className="mt-1.5" />
        </div>
      </Story>
      ...
      >
        <div className="max-w-sm space-y-3">
          <div>
            ...
            <MaskedInput mask="###-###" placeholder="123-456" className="mt-1.5" />
          </div>
          <div>
            <Label>Letters Only (tries typing numbers are blocked)</Label>
            <MaskedInput mask="AAA-AAA" replacement="A" placeholder="ABC-DEF" className="mt-1.5" />
          </div>
        </div>
      </Story>
      ...
      <Story title="Disabled & Readonly" description="Non-interactive states.">
        <div className="max-w-sm space-y-2">
          <MaskedInput mask="(###) ###-####" defaultValue="(555) 123-4567" disabled />
          <MaskedInput mask="(###) ###-####" defaultValue="(555) 999-8888" readOnly />
        </div>
      </Story>
    </>
  )
