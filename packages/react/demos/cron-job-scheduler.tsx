...
import { CronJobScheduler, type CronJob } from '@react-registry-blocks/cron-job-scheduler/CronJobScheduler'
...
export default function CronJobSchedulerDemo() {
  return (
    <>
      <Story
        title="Default"
