...
import { RawChart } from "@react-registry/charts";

// In React, the charts module `use()`-registers every chart type at module
// load, so RawChart can render any of them via `option` without the consumer
// registering anything (unlike the Vue vue-echarts build, which needs an
// explicit `use([...])` call).
...
export default function RawChartDemo() {
  return (
    <>
      <Story
