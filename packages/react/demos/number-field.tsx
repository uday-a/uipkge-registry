...
export default function NumberFieldDemo() {
  ...
  return (
    <>
      ...
      <Story
        title="Sizes"
        description="Small, middle (default), and large sizes."
      >
        <div className="flex items-center gap-4">
          <NumberField
            value={sized}
            onValueChange={setSized}
            size="small"
            min={0}
          />
          <NumberField
      ...
      >
        <div className="max-w-xs space-y-2">
          ...
          <NumberField
            value={rightControls}
            onValueChange={setRightControls}
