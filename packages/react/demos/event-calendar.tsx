...
import { Headphones, Plane, GraduationCap, Wrench } from 'lucide-react'
import { EventCalendar, type CalendarEvent, type EventTypeMeta } from '@react-registry-blocks/event-calendar'
...
const initialCustomEvents: CalendarEvent[] = [
...
export default function EventCalendarDemo() {
  ...
  const [customEvents, setCustomEvents] = useState<CalendarEvent[]>(initialCustomEvents)
  const [minimalEvents, setMinimalEvents] = useState<CalendarEvent[]>(initialEvents)
  ...
  return (
    <>
      ...
      >
        <EventCalendar events={events} onEventsChange={setEvents} initialDate="2026-05-16" />
      </Story>
      ...
      >
        <EventCalendar
          events={customEvents}
          onEventsChange={setCustomEvents}
      ...
      >
        <EventCalendar events={[]} loading initialDate="2026-05-16" />
      </Story>
      ...
      >
        <EventCalendar
          ...
          onEventsChange={setMinimalEvents}
          initialDate="2026-05-16"
          showStats={false}
          showSideRail={false}
          showLegend={false}
