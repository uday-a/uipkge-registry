...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@react-registry/collapsible";
      ...
      >
        <div className="space-y-3">
          <Collapsible open={open} onOpenChange={setOpen} className="max-w-md">
            ...
            <div className="mt-1 rounded-md border px-4 py-2 font-mono text-sm">
              @radix-ui/primitives
            </div>
        ...
        >
          ...
          <CollapsibleContent className="mt-2 space-y-1.5">
            <div className="rounded-md border px-4 py-2 text-sm">
              ...
              <code className="text-foreground/90 ml-2 font-mono text-xs">
