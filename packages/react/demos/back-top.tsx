    ...
    <>
      ...
      >
        <Card className="max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              Scroll the list below to reveal the back-to-top button.
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      >
        <p className="text-muted-foreground max-w-md text-sm">
          Scroll the page itself to reveal the floating button. It
        ...
        <div className="max-w-md space-y-1 text-xs">
          ...
          {visibleLog.length === 0 && (
            <p className="text-muted-foreground">
              Scroll the page to fire onVisible events.
            </p>
          )}
        </div>
      </Story>
      ...
      >
        <p className="text-muted-foreground max-w-md text-sm">
          Use a higher <code className="text-foreground">threshold</code> like
          600px to delay visibility until the user has scrolled significantly.
          Set <code className="text-foreground">behavior="auto"</code> for an
          instant jump instead of the default animated scroll.
        </p>
      </Story>
    </>
  );
