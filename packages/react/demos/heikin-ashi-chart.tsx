...
import { HeikinAshiChart } from '@react-registry/charts'

// TPEB spot rate OHLC ($/kg), weekly sample.
const tpeb = [
...
export default function HeikinAshiChartDemo() {
  return (
    <>
      <Story
        title="TPEB spot trend"
        description="Averaged candles smear the weekly chop into one clean uptrend into peak."
      >
        <HeikinAshiChart data={tpeb} height={340} />
      </Story>
      <Story title="With zoom" description="Slider plus inside-zoom for long rate histories.">
        <HeikinAshiChart data={tpeb} zoom height={340} />
      </Story>
    </>
  )
}
