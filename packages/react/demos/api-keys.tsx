...
import { ApiKeys } from '@react-registry-blocks/api-keys/ApiKeys'
...
export default function ApiKeysDemo() {
  return (
    <>
      ...
      <Story title="Compact density" description="Compact density tightens row padding for dense settings pages.">
