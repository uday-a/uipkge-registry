...
import { DottedMapChart } from '@react-registry/charts'
...
export default function DottedMapChartDemo() {
  return (
    <>
      <Story
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-2 text-xs">
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              ...
              <span className="text-foreground font-medium">Active Corridors:</span> 7 Links
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">Global Bandwidth:</span> 26.2 Tbps
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">Global P95 RTT:</span> 34ms
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">Packet Loss:</span> 0.001%
            </div>
          </div>
      ...
      >
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-2 text-xs">
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">Sortation Hubs:</span> 7 Facilities
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">Volume:</span> 624,000 pkgs/hr
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">On-Time Rate:</span> 99.4%
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-2 text-xs">
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              ...
              <span className="text-foreground font-medium">WAF Status:</span> Automated Defense Active
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">Peak Ingress:</span> 665 Gbps
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">Scrubbing Efficiency:</span> 99.85%
            </div>
          </div>
      ...
      <Story title="Themed matrix" description="Custom dot coloring via theme tokens or brand variables.">
        <DottedMapChart pins={clusterStatus.slice(0, 3)} dotColor="var(--chart-2)" height={340} />
      </Story>
