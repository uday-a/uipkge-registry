  ...
  return (
    <>
      ...
      >
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-2 text-xs">
            ...
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">Packet Loss:</span>{" "}
              0.001%
            </div>
          </div>
          <DottedMapChart
      ...
      >
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-2 text-xs">
            ...
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">On-Time Rate:</span>{" "}
              99.4%
            </div>
          </div>
          <DottedMapChart
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-2 text-xs">
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              ...
              <span className="text-foreground font-medium">WAF Status:</span>{" "}
              Automated Defense Active
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">Peak Ingress:</span>{" "}
              665 Gbps
            </div>
            <div className="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1">
              <span className="text-foreground font-medium">
      ...
      <Story
        ...
        description="Diagonal staggered layout with hexagonal cells."
      >
        <DottedMapChart
          pins={globalNodes.slice(0, 4)}
          grid="diagonal"
          shape="hexagon"
          height={340}
        />
      ...
      <Story
        title="Themed matrix"
        description="Custom dot coloring via theme tokens or brand variables."
      >
        <DottedMapChart
          pins={clusterStatus.slice(0, 3)}
