    ...
    <>
      ...
      <Story title="Direction" description="direction controls the gradient axis.">
        <div className="space-y-2 text-2xl font-bold">
          ...
          <GradientText from="#7c3aed" to="#ec4899" direction="to top right">
            to top right
          </GradientText>
          <GradientText from="#7c3aed" to="#ec4899" direction="to bottom left">
            to bottom left
          </GradientText>
        </div>
      </Story>
      ...
      <Story title="Animated presets" description="All presets with the animated flag — each flows continuously.">
        <div className="space-y-3">
          ...
          <p className="text-2xl font-bold">
            <GradientText preset="rainbow" animated>
              Rainbow Flow
            </GradientText>
          </p>
          <p className="text-2xl font-bold">
            <GradientText preset="sunset" animated>
              Sunset Flow
            </GradientText>
          </p>
          <p className="text-2xl font-bold">
            <GradientText preset="ocean" animated>
              Ocean Flow
            </GradientText>
          </p>
          <p className="text-2xl font-bold">
            <GradientText preset="fire" animated>
              Fire Flow
            </GradientText>
          </p>
          <p className="text-2xl font-bold">
            <GradientText preset="neon" animated>
              Neon Flow
            </GradientText>
          </p>
        </div>
      ...
      >
        <div className="space-y-3">
          <p className="text-2xl font-bold">
            <GradientText preset="aurora" animated animationDuration={2}>
              2s — Fast
            </GradientText>
          </p>
          <p className="text-2xl font-bold">
            <GradientText preset="aurora" animated animationDuration={4}>
              4s — Default
            </GradientText>
          </p>
          <p className="text-2xl font-bold">
            <GradientText preset="aurora" animated animationDuration={8}>
              8s — Slow
            </GradientText>
          </p>
        </div>
      ...
      >
        <p className="text-base">
          ...
          <GradientText preset="fire" animated className="font-semibold">
            animated highlight
          </GradientText>
