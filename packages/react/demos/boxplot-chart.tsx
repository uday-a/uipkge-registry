...
import { BoxplotChart } from "@react-registry/charts";

const latencies = [
  {
    category: "US-W",
    values: [120, 145, 165, 180, 215] as [
      number,
      number,
      number,
      number,
...
const scores = [
  {
    category: "Group A",
    values: [42, 56, 68, 78, 92] as [number, number, number, number, number],
  },
  {
    category: "Group B",
    values: [48, 60, 71, 80, 94] as [number, number, number, number, number],
  },
  {
    category: "Group C",
    values: [52, 65, 74, 84, 96] as [number, number, number, number, number],
  },
];
...
const buildTimes = [
  {
    category: "Small",
    values: [12, 18, 24, 32, 48] as [number, number, number, number, number],
  },
  {
    category: "Medium",
    values: [28, 42, 58, 78, 110] as [number, number, number, number, number],
  },
  {
    category: "Large",
    values: [55, 95, 140, 220, 380] as [number, number, number, number, number],
  },
  {
    category: "XL",
    values: [110, 180, 260, 380, 620] as [
      number,
      number,
      number,
      number,
...
export default function BoxplotChartDemo() {
  return (
    <>
      ...
      >
        <BoxplotChart data={latencies} horizontal height={320} />
      </Story>
      ...
      >
        <BoxplotChart data={buildTimes} horizontal height={340} />
      </Story>
