                ...
                <div className="border-border bg-card rounded-xl border p-4 shadow-xs">
                  ...
                  <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-foreground font-mono text-xs font-medium">
                        Slot Children / Text
                      </label>
                      <input
                        type="text"
                    ...
                    <tbody className="divide-border/60 divide-y">
                      {propsList.map((prop) => (
                        <tr key={prop.name} className="hover:bg-muted/20">
                          <td className="text-foreground py-2.5 pr-3 font-mono font-medium">
                            {prop.name}
                          </td>
                          ...
                          <td className="text-muted-foreground py-2.5 leading-relaxed">
                            {prop.doc || "—"}
                          </td>
                        </tr>
                      ))}
                ...
                <div className="border-border border-t pt-4">
                  ...
                  <div className="space-y-3">
                    {typeDecls.map((decl) => (
                      ...
                      >
                        <div className="text-foreground mb-1.5 font-mono text-xs font-bold">
                          {decl.name}
                        </div>
