    ...
    <header className="border-border bg-card z-20 flex h-14 shrink-0 items-center justify-between gap-2 border-b px-3 select-none sm:gap-4 sm:px-4">
      ...
      <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-2.5">
        ...
        {!isSidebarOpen && (
          <button
            type="button"
            className="border-border bg-background text-muted-foreground hover:text-foreground hover:bg-muted flex size-8 shrink-0 cursor-pointer items-center justify-center rounded-lg border shadow-2xs transition"
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          <div className="flex shrink-0 items-center gap-1">
            <span className="border-border bg-muted/40 text-foreground inline-flex h-7 shrink-0 items-center rounded-md border px-2 font-mono text-xs font-semibold whitespace-nowrap shadow-2xs">
              React 19
            </span>
            <a
              ...
              className="border-border bg-muted/40 text-muted-foreground hover:text-foreground hover:bg-muted hidden h-7 shrink-0 items-center rounded-md border px-2 font-mono text-xs whitespace-nowrap transition sm:inline-flex"
            >
              <span>Vue 3.5</span>
        ...
        <div className="flex min-w-0 shrink items-center gap-1.5">
          <span className="text-foreground max-w-[140px] min-w-0 shrink truncate text-xs font-semibold tracking-tight whitespace-nowrap sm:text-sm md:max-w-[200px]">
            {componentName}
          </span>
          {category && (
            <span className="border-border text-muted-foreground hidden shrink-0 rounded-md border px-2 py-0.5 font-mono text-xs whitespace-nowrap xl:inline-block">
              {category}
            </span>
          )}
        </div>
        ...
        <button
          ...
          className="border-border bg-background text-muted-foreground hover:text-foreground hover:bg-muted flex size-8 shrink-0 cursor-pointer items-center justify-center rounded-lg border shadow-xs transition min-[1400px]:hidden"
          onClick={copyInstallCommand}
        >
          {copiedCmd ? (
      ...
      <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
        ...
        <div className="border-border bg-muted/40 hidden shrink-0 items-center rounded-lg border p-0.5 shadow-xs lg:flex">
        ...
        <button
          ...
          className="border-border bg-background text-muted-foreground hover:text-foreground hover:bg-muted flex size-8 shrink-0 cursor-pointer items-center justify-center rounded-md border shadow-xs transition-[color,background-color,transform] duration-300 active:rotate-180"
          onClick={onRemount}
        >
        ...
        <div className="relative shrink-0">
          ...
          {showThemePopover && (
            <div className="border-border bg-popover/95 text-popover-foreground animate-in fade-in-0 zoom-in-95 absolute top-11 right-0 z-50 w-80 rounded-[14px] border p-4 shadow-2xl backdrop-blur-md duration-150">
              {/* Header */}
              <div className="border-border mb-3.5 flex items-center justify-between border-b pb-3">
                <div className="flex items-center gap-2">
                  <div className="border-border bg-muted/50 text-foreground flex size-7 items-center justify-center rounded-[8px] border shadow-2xs">
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  {COLOR_THEMES.map((theme) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          className="relative flex size-3.5 shrink-0 items-center justify-center rounded-full border border-black/10 shadow-2xs transition-transform group-hover:scale-110 dark:border-white/20"
        ...
        >
          ...
          <span className="hidden whitespace-nowrap md:inline">Test Bench</span>
        </button>
      </div>
    </header>
  )
