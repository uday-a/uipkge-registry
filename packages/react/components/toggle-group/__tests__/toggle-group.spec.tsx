...
describe('ToggleGroup', () => {
  ...
  it('shows indicator for single-select', () => {
    ...
    expect(container.querySelector('[data-slot="toggle-group-indicator"]')).toBeTruthy()
  })
  ...
  it('applies data-size', () => {
    ...
    expect(container.querySelector('[data-slot="toggle-group"]')?.getAttribute('data-size')).toBe('sm')
  })

  it('applies data-variant', () => {
    const { container } = render(
      <ToggleGroup type="single" value="" variant="outline" onValueChange={() => {}}>
        <ToggleGroupItem value="a">A</ToggleGroupItem>
      </ToggleGroup>,
    )
    expect(container.querySelector('[data-slot="toggle-group"]')?.getAttribute('data-variant')).toBe('outline')
  })
  ...
  it('disables items when group disabled', () => {
    ...
    expect(container.querySelector('[data-slot="toggle-group-item"]')?.hasAttribute('disabled')).toBe(true)
  })
  ...
  it('does not show indicator for multiple type by default', () => {
    ...
    expect(container.querySelector('[data-slot="toggle-group-indicator"]')).toBeNull()
  })
