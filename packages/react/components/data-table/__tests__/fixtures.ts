...
export const selectColumn: ColumnDef<Employee> = {
  ...
  header: ({ table }) =>
    createElement('input', {
      ...
      onChange: (e: { target: HTMLInputElement }) => table.toggleAllPageRowsSelected(e.target.checked),
    }),
  cell: ({ row }) =>
    createElement('input', {
      type: 'checkbox',
      ...
      onChange: (e: { target: HTMLInputElement }) => row.toggleSelected(e.target.checked),
    }),
}
...
export const sortableColumns: ColumnDef<Employee>[] = [
  ...
  {
    accessorKey: 'name',
    header: ({ column }) => createElement(DataTableColumnHeader, { column, label: 'Name' }),
  },
  {
    accessorKey: 'email',
    header: ({ column }) => createElement(DataTableColumnHeader, { column, label: 'Email' }),
  },
  {
    accessorKey: 'role',
    header: ({ column }) => createElement(DataTableColumnHeader, { column, label: 'Role' }),
  },
  {
    accessorKey: 'department',
    header: ({ column }) => createElement(DataTableColumnHeader, { column, label: 'Department' }),
  },
  {
    accessorKey: 'status',
    header: ({ column }) => createElement(DataTableColumnHeader, { column, label: 'Status' }),
  },
]
