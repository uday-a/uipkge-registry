...
export default defineRegistryItem({
  ...
  files: [
    ...
    { path: 'DataTableColumnHeader.tsx', target: 'components/ui/data-table/DataTableColumnHeader.tsx' },
    { path: 'DataTableFilterPopover.tsx', target: 'components/ui/data-table/DataTableFilterPopover.tsx' },
    { path: 'DataTableFilterSheet.tsx', target: 'components/ui/data-table/DataTableFilterSheet.tsx' },
    { path: 'DataTablePagination.tsx', target: 'components/ui/data-table/DataTablePagination.tsx' },
    { path: 'DataTableToolbar.tsx', target: 'components/ui/data-table/DataTableToolbar.tsx' },
