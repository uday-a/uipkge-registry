...
function ProgressLinear({
  ...
  const heightValue = typeof height === 'number' ? `${height}px` : typeof height === 'string' ? height : '4px'
  ...
  return (
    ...
    >
      ...
      {stream && !indeterminate && active && (
        <div className={cn('absolute inset-0 overflow-hidden', reverse ? 'right-0 left-auto' : 'right-auto left-0')}>
          <div
