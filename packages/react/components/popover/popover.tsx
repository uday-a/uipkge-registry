...
>((props, ref) => <PopoverPrimitive.Trigger ref={ref} data-uipkge="" data-slot="popover-trigger" {...props} />)
PopoverTrigger.displayName = PopoverPrimitive.Trigger.displayName

const PopoverAnchor = React.forwardRef<
  React.ElementRef<typeof PopoverPrimitive.Anchor>,
  React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Anchor>
>((props, ref) => <PopoverPrimitive.Anchor ref={ref} data-uipkge="" data-slot="popover-anchor" {...props} />)
...
>(({ className, align = 'center', sideOffset = 4, onPointerDownOutside, onEscapeKeyDown, ...props }, ref) => {
  ...
  function handlePointerDownOutside(
    e: Parameters<
      NonNullable<React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Content>['onPointerDownOutside']>
    >[0],
  ) {
