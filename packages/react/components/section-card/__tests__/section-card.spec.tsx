...
describe('SectionCard', () => {
  ...
  it('renders the description when provided', () => {
    const { container } = render(<SectionCard title="T" description="A description" />)
  ...
  it('renders children content', () => {
    const { container } = render(<SectionCard title="T">Body content</SectionCard>)
    expect(container.textContent).toContain('Body content')
  })

  it('renders headerAction prop', () => {
    const { container } = render(<SectionCard title="T" headerAction={<button>Action</button>} />)
    expect(container.textContent).toContain('Action')
  })

  it('renders footer prop', () => {
    const { container } = render(<SectionCard title="T" footer={<div>Footer text</div>} />)
