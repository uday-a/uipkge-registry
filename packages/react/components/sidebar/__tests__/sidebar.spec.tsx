...
describe('Sidebar', () => {
  ...
  it('has data-uipkge on root', () => {
    ...
    expect(container.querySelector('[data-slot="sidebar"][data-uipkge]')).toBeTruthy()
  })
...
describe('SidebarProvider', () => {
  ...
  it('has data-uipkge on wrapper', () => {
    ...
    expect(container.querySelector('[data-slot="sidebar-wrapper"][data-uipkge]')).toBeTruthy()
  })
})
