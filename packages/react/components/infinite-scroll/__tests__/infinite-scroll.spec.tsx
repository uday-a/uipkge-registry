...
describe("InfiniteScroll", () => {
  ...
  it("has data-uipkge on container", () => {
    const { container } = render(<InfiniteScroll />);
    expect(
      container.querySelector('[data-slot="infinite-scroll"][data-uipkge]'),
    ).toBeTruthy();
  });
  ...
  it("renders a sentinel element", () => {
    const { container } = render(<InfiniteScroll />);
    expect(
      container.querySelector('[data-slot="infinite-scroll-sentinel"]'),
    ).toBeTruthy();
  });
  ...
  it("renders loader when loading is true", () => {
    ...
    expect(
      container.querySelector('[data-slot="infinite-scroll-loading"]'),
    ).toBeTruthy();
  });
