...
describe('BarRaceChart', () => {
  const sampleProps = { frames: [{ label: '2020', values: [{ name: 'A', value: 10 }] }] }
  ...
  it('renders expected content or unique feature', () => {
    const { container, unmount } = render(<BarRaceChart {...sampleProps} className="custom-chart-test" height={380} />)
    expect(container).toBeDefined()
