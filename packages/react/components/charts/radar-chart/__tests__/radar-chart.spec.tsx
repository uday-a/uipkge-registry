...
describe('RadarChart', () => {
  const sampleProps = { indicators: [{ name: 'A', max: 100 }], data: [{ name: 'Series', value: [50] }] }
  ...
  it('renders expected content or unique feature', () => {
    const { container, unmount } = render(<RadarChart {...sampleProps} className="custom-chart-test" height={380} />)
    expect(container).toBeDefined()
