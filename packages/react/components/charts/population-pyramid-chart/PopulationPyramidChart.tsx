...
export const PopulationPyramidChart = React.forwardRef<HTMLDivElement, PopulationPyramidChartProps>(
  ({ data, names = ['Male', 'Female'], height = 340, option, className, ariaLabel }, ref) => {
