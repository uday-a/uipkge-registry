...
export const HeikinAshiChart = React.forwardRef<HTMLDivElement, HeikinAshiChartProps>(
  ({ data, height = 320, zoom = false, option, className, ariaLabel }, ref) => {
    ...
    return (
      <ChartFrame ref={ref} height={height} className={className} ariaLabel={ariaLabel || 'Heikin-Ashi chart'}>
