...
describe('BubbleMap', () => {
  const sampleProps = { bubbles: [{ id: '1', name: 'Node', lat: 0, lng: 0, value: 10 }] }
  ...
  it('renders expected content or unique feature', () => {
    const { container, unmount } = render(<BubbleMap {...sampleProps} className="custom-chart-test" height={380} />)
    expect(container).toBeDefined()
