...
describe('DumbbellChart', () => {
  const sampleProps = { data: [{ category: 'A', start: 10, end: 20 }], names: ['Q1', 'Q2'] }
  ...
  it('renders expected content or unique feature', () => {
    const { container, unmount } = render(<DumbbellChart {...sampleProps} className="custom-chart-test" height={380} />)
    expect(container).toBeDefined()
