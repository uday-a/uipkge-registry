...
export const ErrorBarChart = React.forwardRef<HTMLDivElement, ErrorBarChartProps>(
  ({ data, height = 300, option, className, ariaLabel }, ref) => {
    ...
    return (
      <ChartFrame ref={ref} height={height} className={className} ariaLabel={ariaLabel || 'Error bar chart'}>
