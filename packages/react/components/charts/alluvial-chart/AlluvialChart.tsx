...
export const AlluvialChart = React.forwardRef<HTMLDivElement, AlluvialChartProps>(
  ({ nodes, links, height = 420, curveness = 0.5, option, className, ariaLabel }, ref) => {
    ...
    return (
      <ChartFrame ref={ref} height={height} className={className} ariaLabel={ariaLabel || 'Alluvial chart'}>
