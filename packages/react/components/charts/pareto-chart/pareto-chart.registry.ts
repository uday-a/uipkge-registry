...
export default defineRegistryItem({
  ...
  categories: ["chart"],
  description:
    "React mirror of @uipkge/pareto-chart — see the Vue registry item for the canonical description.",
  files: [
    {
      path: "ParetoChart.tsx",
      target: "components/ui/charts/pareto-chart/ParetoChart.tsx",
    },
