...
export const BeeswarmChart = React.forwardRef<HTMLDivElement, BeeswarmChartProps>(
  ({ data, valueField = 'value', groupField = 'group', height = 300, option, className, ariaLabel }, ref) => {
