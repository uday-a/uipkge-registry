...
export default defineRegistryItem({
  ...
  categories: ["chart"],
  description:
    "React mirror of @uipkge/parallel-chart — see the Vue registry item for the canonical description.",
  files: [
    {
      path: "ParallelChart.tsx",
      target: "components/ui/charts/parallel-chart/ParallelChart.tsx",
    },
    {
      path: "index.ts",
