...
export default defineRegistryItem({
  ...
  categories: ["chart"],
  description:
    "React mirror of @uipkge/range-area-chart — see the Vue registry item for the canonical description.",
  files: [
    {
      path: "RangeAreaChart.tsx",
      target: "components/ui/charts/range-area-chart/RangeAreaChart.tsx",
    },
    {
      path: "index.ts",
