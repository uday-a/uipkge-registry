...
export default defineRegistryItem({
  ...
  categories: ["chart"],
  description:
    "React mirror of @uipkge/marimekko-chart — see the Vue registry item for the canonical description.",
  files: [
    {
      path: "MarimekkoChart.tsx",
      target: "components/ui/charts/marimekko-chart/MarimekkoChart.tsx",
    },
    {
      path: "index.ts",
