...
export const MarimekkoChart = React.forwardRef<HTMLDivElement, MarimekkoChartProps>(
  ({ columns, height = 340, option, className, ariaLabel }, ref) => {
    ...
    return (
      <ChartFrame ref={ref} height={height} className={className} ariaLabel={ariaLabel || 'Marimekko chart'}>
