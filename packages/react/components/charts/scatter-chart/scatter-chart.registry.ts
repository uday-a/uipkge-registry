...
export default defineRegistryItem({
  ...
  categories: ["chart"],
  description:
    "React mirror of @uipkge/scatter-chart — see the Vue registry item for the canonical description.",
  files: [
    {
      path: "ScatterChart.tsx",
      target: "components/ui/charts/scatter-chart/ScatterChart.tsx",
    },
