...
describe('SunburstChart', () => {
  const sampleProps = { data: [{ name: 'Root', children: [{ name: 'Leaf', value: 10 }] }] }
  ...
  it('renders expected content or unique feature', () => {
    const { container, unmount } = render(<SunburstChart {...sampleProps} className="custom-chart-test" height={380} />)
    expect(container).toBeDefined()
