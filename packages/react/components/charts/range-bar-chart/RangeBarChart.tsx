...
export const RangeBarChart = React.forwardRef<HTMLDivElement, RangeBarChartProps>(
  ({ data, orientation = 'vertical', height = 300, option, className, ariaLabel }, ref) => {
    ...
    return (
      <ChartFrame ref={ref} height={height} className={className} ariaLabel={ariaLabel || 'Range bar chart'}>
