...
export default defineRegistryItem({
  ...
  categories: ["chart"],
  description:
    "React mirror of @uipkge/nightingale-chart — see the Vue registry item for the canonical description.",
  files: [
    {
      path: "NightingaleChart.tsx",
      target: "components/ui/charts/nightingale-chart/NightingaleChart.tsx",
    },
    {
      path: "index.ts",
