...
export default defineRegistryItem({
  ...
  categories: ["chart"],
  description:
    "React mirror of @uipkge/icicle-chart — see the Vue registry item for the canonical description.",
  files: [
    {
      path: "IcicleChart.tsx",
      target: "components/ui/charts/icicle-chart/IcicleChart.tsx",
    },
