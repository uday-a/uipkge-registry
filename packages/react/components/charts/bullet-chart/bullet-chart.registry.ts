...
export default defineRegistryItem({
  ...
  categories: ["chart"],
  description:
    "React mirror of @uipkge/bullet-chart — see the Vue registry item for the canonical description.",
  files: [
    {
      path: "BulletChart.tsx",
      target: "components/ui/charts/bullet-chart/BulletChart.tsx",
    },
