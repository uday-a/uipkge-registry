...
describe("OverlayScroll", () => {
  it('renders with data-slot="overlay-scroll"', () => {
    ...
    expect(
      container.querySelector('[data-slot="overlay-scroll"]'),
    ).toBeTruthy();
  });
  ...
  it('renders viewport with data-slot="overlay-scroll-viewport"', () => {
    const { container } = render(<OverlayScroll />);
    expect(
      container.querySelector('[data-slot="overlay-scroll-viewport"]'),
    ).toBeTruthy();
  });
  ...
  it('renders thumb with data-slot="overlay-scroll-thumb"', () => {
    const { container } = render(<OverlayScroll />);
    expect(
      container.querySelector('[data-slot="overlay-scroll-thumb"]'),
    ).toBeTruthy();
  });
  ...
  it("applies custom className to the container", () => {
    ...
    expect(
      container.querySelector('[data-slot="overlay-scroll"]')?.className,
    ).toContain("h-64");
  });
});
