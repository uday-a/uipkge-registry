...
describe('Toggle', () => {
  ...
  it('renders button', () => {
    const { container } = render(<Toggle>Toggle</Toggle>)
    expect(container.querySelector('[data-slot="toggle"]')?.tagName.toLowerCase()).toBe('button')
  })
  ...
  it('shows off state (data-state="off")', () => {
    ...
    expect(container.querySelector('[data-slot="toggle"]')?.getAttribute('data-state')).toBe('off')
  })
  ...
  it('shows on state (data-state="on")', () => {
    ...
    expect(container.querySelector('[data-slot="toggle"]')?.getAttribute('data-state')).toBe('on')
  })
  ...
  it('disables when disabled', () => {
    ...
    expect(container.querySelector('[data-slot="toggle"]')?.hasAttribute('disabled')).toBe(true)
  })
