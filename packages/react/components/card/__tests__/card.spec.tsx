...
describe('Card', () => {
  ...
  it('renders as a div', () => {
    const { container } = render(<Card />)
    expect(container.querySelector('[data-slot="card"]')?.tagName.toLowerCase()).toBe('div')
  })
  ...
  it('CardTitle renders as h3 by default', () => {
    const { container } = render(<CardTitle>Title</CardTitle>)
    expect(container.querySelector('[data-slot="card-title"]')?.tagName.toLowerCase()).toBe('h3')
  })
  ...
  it('CardDescription renders as a p element', () => {
    const { container } = render(<CardDescription>Description</CardDescription>)
    expect(container.querySelector('[data-slot="card-description"]')?.tagName.toLowerCase()).toBe('p')
  })
  ...
  it('applies variant classes', () => {
    ...
    expect(container.querySelector('[data-slot="card"]')?.className).toContain('shadow-md')
  })
