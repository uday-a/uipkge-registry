...
describe("AdvanceSelect", () => {
  it('renders root with data-slot="advance-select"', () => {
    const { container } = render(
      <AdvanceSelect options={options} onValueChange={() => {}} />,
    );
    expect(
      container.querySelector('[data-slot="advance-select"]'),
    ).toBeTruthy();
  });
  ...
  it("disables trigger when disabled is true", () => {
    const { container } = render(
      <AdvanceSelect options={options} disabled onValueChange={() => {}} />,
    );
    const trigger = container.querySelector('[data-slot="advance-select"]');
  ...
  it("calls onValueChange when option is selected", () => {
    ...
    const { container } = render(
      <AdvanceSelect options={options} open onValueChange={onValueChange} />,
    );
