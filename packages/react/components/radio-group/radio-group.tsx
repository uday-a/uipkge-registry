...
const RadioGroupItem = React.forwardRef<React.ElementRef<typeof RadioGroupPrimitive.Item>, RadioGroupItemProps>(
  (
    ...
    const effectiveDisabled = Boolean(loading) || Boolean(disabled ?? groupContext.disabled ?? false)
    ...
    return (
      <div className={cn('flex flex-col', itemDensityClasses[density])}>
        ...
        {hint && !hasError && <p className="text-muted-foreground ml-6 text-xs">{hint}</p>}
