...
describe("RadioGroup", () => {
  ...
  it("renders label", () => {
    const { getByText } = render(
      <RadioGroup value="" label="Group label" onValueChange={() => {}} />,
    );
  ...
  it("renders hint", () => {
    const { getByText } = render(
      <RadioGroup value="" hint="Pick one" onValueChange={() => {}} />,
    );
  ...
  it("renders error messages", () => {
    const { getByText } = render(
      <RadioGroup
        value=""
        errorMessages="Selection required"
        onValueChange={() => {}}
      />,
    );
  ...
  it("renders options with labels", () => {
    ...
    expect(
      container.querySelectorAll('[data-slot="radio-group-item"]').length,
    ).toBe(1);
  });
  ...
  it("renders button-style options", () => {
    ...
    expect(
      container.querySelectorAll('[data-slot="radio-button"]').length,
    ).toBe(2);
  });

  it("renders string options", () => {
    const { container } = render(
      <RadioGroup value="" onValueChange={() => {}} options={["x", "y"]} />,
    );
    expect(
      container.querySelectorAll('[data-slot="radio-group-item"]').length,
    ).toBe(2);
