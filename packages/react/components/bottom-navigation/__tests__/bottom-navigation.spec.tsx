...
describe("BottomNavigation", () => {
  it('renders nav with data-slot="bottom-navigation"', () => {
    const { container } = render(
      <BottomNavigation items={items} value="home" onValueChange={() => {}} />,
    );
    expect(
  ...
  it("applies data-active to the active item", () => {
    ...
    const activeItem = container.querySelector(
      '[data-slot="bottom-navigation-item"][data-active]',
    );
  ...
  it("renders icons for each item", () => {
    ...
    const icons = container.querySelectorAll(
      '[data-slot="bottom-navigation-icon"]',
    );
  ...
  it("renders indicator when showIndicator is true", () => {
    ...
    expect(
      container.querySelector('[data-slot="bottom-navigation-indicator"]'),
    ).toBeTruthy();
  });
