...
function TreeViewNode({ item, depth, isLast = false, parentId = null }: TreeViewNodeProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Icon */}
        {Icon && <Icon className={cn('size-4 shrink-0', hasChildren ? 'text-primary' : 'text-muted-foreground')} />}
