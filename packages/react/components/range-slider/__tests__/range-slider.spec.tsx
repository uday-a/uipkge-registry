...
describe("RangeSlider", () => {
  it('renders with data-slot="range-slider"', () => {
    const { container } = render(
      <RangeSlider value={[20, 80]} onValueChange={() => {}} />,
    );
  ...
  it("disables when disabled", () => {
    const { container } = render(
      <RangeSlider value={[20, 80]} disabled onValueChange={() => {}} />,
    );
    expect(
      container
        .querySelector('[data-slot="range-slider"]')
  ...
  it("respects min and max props", () => {
    const { container } = render(
      <RangeSlider value={[5, 15]} min={0} max={50} onValueChange={() => {}} />,
    );
    const thumbs = container.querySelectorAll('[role="slider"]');
