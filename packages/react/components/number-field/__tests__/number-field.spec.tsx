...
describe("NumberField", () => {
  ...
  it("increments when button clicked", () => {
    ...
    const { container } = render(
      <NumberField value={5} onValueChange={onValueChange} />,
    );
  ...
  it("respects min", () => {
    const onValueChange = vi.fn();
    const { container } = render(
      <NumberField value={1} min={0} onValueChange={onValueChange} />,
    );
    const decrement = container.querySelector('[data-slot="decrement"]')!;
    fireEvent.click(decrement);
  ...
  it("disables decrement button at min", () => {
    const { container } = render(
      <NumberField value={0} min={0} onValueChange={() => {}} />,
    );
    expect(
      container
        .querySelector('[data-slot="decrement"]')
  ...
  it("respects max", () => {
    const onValueChange = vi.fn();
    const { container } = render(
      <NumberField value={9} max={10} onValueChange={onValueChange} />,
    );
    const increment = container.querySelector('[data-slot="increment"]')!;
    fireEvent.click(increment);
  ...
  it("disables increment button at max", () => {
    const { container } = render(
      <NumberField value={10} max={10} onValueChange={() => {}} />,
    );
    expect(
      container
        .querySelector('[data-slot="increment"]')
        ?.hasAttribute("disabled"),
    ).toBe(true);
  });
  ...
  it("respects step", () => {
    const onValueChange = vi.fn();
    const { container } = render(
      <NumberField value={5} step={5} onValueChange={onValueChange} />,
    );
    const increment = container.querySelector('[data-slot="increment"]')!;
    fireEvent.click(increment);
    expect(onValueChange).toHaveBeenCalledWith(10);
  ...
  it("disables when disabled", () => {
    const { container } = render(
      <NumberField value={5} disabled onValueChange={() => {}} />,
    );
  ...
  it("renders prefix", () => {
    const { getByText } = render(
      <NumberField value={5} prefix="$" onValueChange={() => {}} />,
    );
  ...
  it("renders suffix", () => {
    const { getByText } = render(
      <NumberField value={5} suffix="kg" onValueChange={() => {}} />,
    );
  ...
  it("sets aria-valuenow", () => {
    const { container } = render(
      <NumberField value={7} onValueChange={() => {}} />,
    );
    expect(
      container.querySelector("input")?.getAttribute("aria-valuenow"),
    ).toBe("7");
  });
