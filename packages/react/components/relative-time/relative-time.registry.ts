...
export default defineRegistryItem({
  ...
  files: [
    { path: 'relative-time.tsx', target: 'components/ui/relative-time/relative-time.tsx' },
    { path: 'format-relative-time.ts', target: 'components/ui/relative-time/format-relative-time.ts' },
