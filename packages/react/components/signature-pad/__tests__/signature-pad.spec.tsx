...
describe('SignaturePad', () => {
  ...
  it('has data-uipkge on container', () => {
    const { container } = render(<SignaturePad />)
    expect(container.querySelector('[data-slot="signature-pad"]')?.hasAttribute('data-uipkge')).toBe(true)
  })
  ...
  it('applies data-disabled when disabled is true', () => {
    ...
    expect(container.querySelector('[data-slot="signature-pad"]')?.hasAttribute('data-disabled')).toBe(true)
  })
