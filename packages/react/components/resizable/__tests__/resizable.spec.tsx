...
describe('Resizable', () => {
  ...
  it('ResizablePanelGroup has data-uipkge', () => {
    ...
    expect(container.querySelector('[data-slot="resizable-panel-group"]')?.hasAttribute('data-uipkge')).toBe(true)
  })
  ...
  it('ResizablePanel renders with data-slot="resizable-panel"', () => {
    ...
    expect(container.querySelector('[data-slot="resizable-panel"]')).toBeTruthy()
  })
  ...
  it('ResizablePanel has data-uipkge', () => {
    ...
    expect(container.querySelector('[data-slot="resizable-panel"]')?.hasAttribute('data-uipkge')).toBe(true)
  })
  ...
  it('ResizableHandle has data-uipkge', () => {
    ...
    expect(container.querySelector('[data-slot="resizable-handle"]')?.hasAttribute('data-uipkge')).toBe(true)
  })
