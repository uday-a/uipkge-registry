...
describe('Collapsible', () => {
  ...
  it('has data-uipkge', () => {
    ...
    expect(container.querySelector('[data-slot="collapsible"]')?.hasAttribute('data-uipkge')).toBe(true)
  })
  ...
  it('CollapsibleTrigger is a button', () => {
    ...
    expect(container.querySelector('[data-slot="collapsible-trigger"]')?.tagName.toLowerCase()).toBe('button')
  })
  ...
  it('CollapsibleContent renders children when open', () => {
    ...
    expect(container.querySelector('[data-slot="collapsible-content"]')?.textContent).toContain('Content body')
  })
  ...
  it('CollapsibleTrigger renders children', () => {
    ...
    expect(container.querySelector('[data-slot="collapsible-trigger"]')?.textContent).toContain('Trigger text')
  })
})
