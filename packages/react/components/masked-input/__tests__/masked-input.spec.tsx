...
describe('MaskedInput', () => {
  ...
  it('displays placeholder text', () => {
    const { container } = render(<MaskedInput mask="##/##/####" placeholder="MM/DD/YYYY" />)
    expect(container.querySelector('input')?.getAttribute('placeholder')).toBe('MM/DD/YYYY')
  })

  it('renders error message and aria-invalid', () => {
    const { container } = render(<MaskedInput mask="##/##/####" value="12" invalid errorMessage="Date is incomplete" />)
