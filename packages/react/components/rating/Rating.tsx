  ...
  (
    ...
    return (
      ...
      >
          ...
          return (
            ...
            >
              {filled ? (
                ...
                <svg viewBox="0 0 24 24" aria-hidden="true" style={{ ...iconStyle, color }}>
                  <defs>
                  ...
                  <path d={STAR_PATH} fill={`url(#${halfId})`} stroke="currentColor" strokeWidth="1" />
                </svg>
              ) : (
                <svg
                  viewBox="0 0 24 24"
        ...
        {showValue && <span className="text-foreground ml-2 font-semibold">{current}</span>}
      </div>
    )
  },
)
