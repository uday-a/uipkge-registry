...
export default defineRegistryItem({
  ...
  files: [
    ...
    { path: 'GanttTimeline.tsx', target: 'components/ui/gantt/GanttTimeline.tsx' },
    { path: 'GanttBar.tsx', target: 'components/ui/gantt/GanttBar.tsx' },
    { path: 'GanttMilestone.tsx', target: 'components/ui/gantt/GanttMilestone.tsx' },
    { path: 'GanttContextMenu.tsx', target: 'components/ui/gantt/GanttContextMenu.tsx' },
