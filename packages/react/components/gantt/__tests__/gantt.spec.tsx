...
describe('Gantt (React)', () => {
  ...
  it('has data-uipkge attribute', () => {
    ...
    expect(container.querySelector('[data-slot="gantt"]')?.hasAttribute('data-uipkge')).toBe(true)
  })
  ...
  it('renders GanttHeader with title', () => {
    ...
    expect(container.querySelector('[data-slot="gantt-header"]')?.textContent).toContain('Test Roadmap')
  })
  ...
  it('renders GanttTree with deliverable item', () => {
    ...
    expect(container.querySelector('[data-slot="gantt-tree"]')?.textContent).toContain('Discovery Phase')
  })
