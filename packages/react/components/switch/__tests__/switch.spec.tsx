...
describe("Switch", () => {
  ...
  it("disables when disabled", () => {
    ...
    expect(
      container.querySelector('[data-slot="switch"]')?.hasAttribute("disabled"),
    ).toBe(true);
  });

  it("disables when loading", () => {
    const { container } = render(
      <Switch checked={false} loading onCheckedChange={() => {}} />,
    );
    expect(
      container.querySelector('[data-slot="switch"]')?.hasAttribute("disabled"),
    ).toBe(true);
  ...
  it("renders checkedChildren text when checked", () => {
    const { getByText } = render(
      <Switch checked={true} checkedChildren="ON" onCheckedChange={() => {}} />,
    );
  ...
  it("renders a button element", () => {
    ...
    expect(
      container.querySelector('[data-slot="switch"]')?.tagName.toLowerCase(),
    ).toBe("button");
  });
  ...
  it("shows loading spinner svg when loading", () => {
    ...
    expect(
      container.querySelector('[data-slot="switch-thumb"] svg'),
    ).toBeTruthy();
  });
});
