...
export const TreeSelectNode = React.memo(
  React.forwardRef<HTMLDivElement, TreeSelectNodeProps>(
    (
      { node, depth, multiple, expandedIds, selectedValues, filteredIds, parentValue = null, onToggle, onSelect },
      ref,
    ) => {
      ...
      const isSelected = !multiple ? selectedValues.has(node.value) : isFullyChecked || isChecked
      ...
      return (
        <div ref={ref} role="treeitem" aria-expanded={hasChildren ? isExpanded : undefined} aria-selected={isSelected}>
          <div
            data-tree-row
