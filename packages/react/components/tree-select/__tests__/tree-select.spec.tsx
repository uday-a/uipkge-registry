...
describe('TreeSelect', () => {
  ...
  it('has data-uipkge on trigger', () => {
    const { container } = render(<TreeSelect data={data} />)
    expect(container.querySelector('[data-slot="tree-select"]')?.hasAttribute('data-uipkge')).toBe(true)
  })
  ...
  it('renders placeholder text when no value selected', () => {
    const { container } = render(<TreeSelect data={data} placeholder="Pick an item" />)
  ...
  it('supports multiple selection with checkboxes', () => {
    const { container } = render(<TreeSelect data={data} multiple defaultExpandAll />)
    fireEvent.click(container.querySelector('[data-slot="tree-select"]')!)
  ...
  it('disables trigger when disabled is true', () => {
    ...
    expect(container.querySelector('[data-slot="tree-select"]')?.hasAttribute('disabled')).toBe(true)
  })
})
