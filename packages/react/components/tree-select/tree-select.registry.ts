...
export default defineRegistryItem({
  ...
  files: [
    { path: 'TreeSelect.tsx', target: 'components/ui/tree-select/TreeSelect.tsx' },
    { path: 'TreeSelectNode.tsx', target: 'components/ui/tree-select/TreeSelectNode.tsx' },
  ...
  dependencies: ['lucide-react', '@radix-ui/react-popover', '@radix-ui/react-slot', 'class-variance-authority'],
