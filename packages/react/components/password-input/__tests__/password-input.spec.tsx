...
describe("PasswordInput", () => {
  it('renders with data-slot="password-input"', () => {
    ...
    expect(
      container.querySelector('[data-slot="password-input"]'),
    ).toBeTruthy();
  ...
  it("hides toggle button when showToggle is false", () => {
    const { container } = render(
      <PasswordInput value="" showToggle={false} onChange={() => {}} />,
    );
  ...
  it("shows strength meter when showStrength is true and value exists", () => {
    const { container } = render(
      <PasswordInput value="weak" showStrength onChange={() => {}} />,
    );
  ...
  it("does not show strength meter when value is empty", () => {
    const { container } = render(
      <PasswordInput value="" showStrength onChange={() => {}} />,
    );
  ...
  it("disables input when disabled prop is true", () => {
    const { container } = render(
      <PasswordInput value="" disabled onChange={() => {}} />,
    );
