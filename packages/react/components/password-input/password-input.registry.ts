...
export default defineRegistryItem({
  ...
  files: [
    { path: 'PasswordInput.tsx', target: 'components/ui/password-input/PasswordInput.tsx' },
    { path: 'password-input.variants.ts', target: 'components/ui/password-input/password-input.variants.ts' },
