...
describe('PaymentCard', () => {
  ...
  it('has role="img"', () => {
    const { container } = render(<PaymentCard />)
    expect(container.querySelector('[data-slot="payment-card"]')?.getAttribute('role')).toBe('img')
  })
  ...
  it('applies compact variant size class', () => {
    ...
    expect(container.querySelector('[data-slot="payment-card"]')?.className).toContain('w-[120px]')
  })
})
