...
export const PaymentCard = React.forwardRef<HTMLDivElement, PaymentCardProps>(
  (
    ...
    const [tiltState, setTiltState] = React.useState({ x: 0, y: 0, active: false })
    ...
    const displayNumber = React.useMemo(() => formatMasked(number, detectedBrand), [number, detectedBrand])
    const displayName = React.useMemo(() => (name.trim() || 'CARDHOLDER NAME').toUpperCase(), [name])
    ...
    const displayChars = React.useMemo(() => displayNumber.split(''), [displayNumber])
      ...
      >
        <div
          className={cn(
            ...
            flip ? 'duration-[650ms] ease-[cubic-bezier(0.22,1,0.36,1)]' : 'duration-300',
          )}
        ...
        >
          ...
          >
            ...
            <svg
              ...
              aria-hidden="true"
            >
              <g stroke={theme.guillocheColor} strokeWidth="0.75" strokeOpacity="0.7">
                ...
                <circle cx="280" cy="80" r="90" strokeWidth="0.5" strokeDasharray="2 3" />
                <circle cx="280" cy="80" r="60" strokeWidth="0.5" strokeDasharray="1 2" />
              </g>
            </svg>
            ...
            {/* Content Structure */}
            <div
              className={cn('absolute inset-0 flex flex-col justify-between', variant === 'compact' ? 'p-2' : 'p-5')}
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  {variant !== 'compact' ? (
                    ...
                    <span className="font-mono text-xs font-bold tracking-widest text-white/70 uppercase">CARD</span>
                  )}
                </div>
                ...
                <div className="flex items-center justify-end">
                  ...
                  {detectedBrand === 'visa' && (
                    <svg
                      className={variant === 'compact' ? 'h-3 w-auto' : 'h-6 w-auto'}
                      viewBox="0 0 78 24"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      aria-label="Visa"
                  ...
                  {detectedBrand === 'mastercard' && (
                    <div className="flex items-center gap-1.5">
                      <svg
                        className={variant === 'compact' ? 'h-3.5 w-auto' : 'h-7 w-auto'}
                        viewBox="0 0 48 30"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      >
                        ...
                        <circle cx="33" cy="15" r="15" fill="#F79E1B" fillOpacity="0.92" />
                        <path
              ...
              <div className="flex items-center justify-between">
                ...
                {variant !== 'compact' && <div className="pay-card-holo h-7 w-9 rounded-[4px] opacity-75 shadow-xs" />}
              </div>
              ...
              <div className="flex items-end justify-between gap-3">
                ...
                <div className="min-w-0 flex-1">
                  {variant !== 'compact' && (
                    <div className={cn('text-xs font-semibold tracking-[0.2em] uppercase', theme.subtextColor)}>
                      CARDHOLDER NAME
                    </div>
                  )}
                  <div
          ...
          >
            ...
            <div className={cn('relative flex flex-col justify-between', variant === 'compact' ? 'p-2' : 'p-4')}>
              ...
              <div className={cn('flex items-stretch gap-2', variant === 'compact' ? 'mt-1' : 'mt-2')}>
                ...
                >
                  {variant !== 'compact' && (
                    <span className="text-[6px] font-bold tracking-widest text-slate-400 uppercase">CVV</span>
                  )}
                  <span className="leading-none tracking-widest italic">{displayCvc}</span>
                </div>
              </div>
              ...
              {variant !== 'compact' && (
                <div className="mt-3 space-y-1.5">
                  ...
                  <div className="flex items-center justify-between border-t border-white/10 pt-2 text-xs font-medium text-white/60">
                    ...
                    <span className="font-mono font-bold tracking-wider text-white/75">CIRRUS · PLUS · STAR</span>
                  </div>
                </div>
              )}
            </div>
