...
describe("List", () => {
  ...
  it("renders as ul by default", () => {
    const { container } = render(<List />);
    expect(
      container.querySelector('[data-slot="list"]')?.tagName.toLowerCase(),
    ).toBe("ul");
  });
...
describe("ListItem", () => {
  ...
  it("renders as li by default", () => {
    const { container } = render(<ListItem>Text</ListItem>);
    expect(
      container.querySelector('[data-slot="list-item"]')?.tagName.toLowerCase(),
    ).toBe("li");
  });
});
...
describe("ListSubheader", () => {
  it('renders with data-slot="list-subheader"', () => {
    ...
    expect(
      container.querySelector('[data-slot="list-subheader"]'),
    ).toBeTruthy();
  });
