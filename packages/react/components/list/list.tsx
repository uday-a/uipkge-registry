...
const List = React.forwardRef<HTMLElement, ListProps>(({ as: Comp = 'ul', className, children, ...props }, ref) => (
  <Comp ref={ref as never} data-uipkge="" data-slot="list" className={cn('list-none space-y-1', className)} {...props}>
    {children}
  </Comp>
))
...
const ListItemMedia = React.forwardRef<HTMLDivElement, ListItemMediaProps>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    data-uipkge=""
    data-slot="list-item-media"
    className={cn('flex shrink-0 items-center justify-center self-center', className)}
    {...props}
  >
    {children}
  </div>
...
const ListItemContent = React.forwardRef<HTMLDivElement, ListItemContentProps>(
  ({ className, children, ...props }, ref) => (
    <div
      ...
      className={cn('flex min-w-0 flex-1 flex-col gap-0.5 self-center', className)}
      {...props}
    >
      {children}
    </div>
...
const ListItemTitle = React.forwardRef<HTMLDivElement, ListItemTitleProps>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    data-uipkge=""
    data-slot="list-item-title"
    className={cn('text-foreground truncate text-sm leading-none font-medium', className)}
    {...props}
  >
    {children}
  </div>
...
const ListItemDescription = React.forwardRef<HTMLDivElement, ListItemDescriptionProps>(
  ({ className, children, ...props }, ref) => (
    <div
      ref={ref}
      data-uipkge=""
...
const ListItemActions = React.forwardRef<HTMLDivElement, ListItemActionsProps>(
  ({ className, children, ...props }, ref) => (
    <div
      ...
      className={cn('text-muted-foreground flex shrink-0 items-center gap-1.5 self-center', className)}
      {...props}
    >
      {children}
    </div>
...
const ListSubheader = React.forwardRef<HTMLDivElement, ListSubheaderProps>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    data-uipkge=""
    data-slot="list-subheader"
    className={cn('text-muted-foreground px-2 py-1 text-xs font-medium tracking-wider uppercase', className)}
    {...props}
  >
    {children}
  </div>
