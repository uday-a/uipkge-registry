...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button> & { label?: string }>(
  ({ className, variant = 'outline', size = 'icon', label = 'Previous slide', children, ...props }, ref) => {
...
const CarouselNext = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button> & { label?: string }>(
  ({ className, variant = 'outline', size = 'icon', label = 'Next slide', children, ...props }, ref) => {
...
const CarouselHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      data-uipkge=""
...
const CarouselFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      data-uipkge=""
