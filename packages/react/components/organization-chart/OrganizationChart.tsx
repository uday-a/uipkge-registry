...
export interface OrganizationChartProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onClick' | 'onToggle'> {
  data: OrgNode
...
const OrganizationChart = React.forwardRef<OrganizationChartHandle, OrganizationChartProps>(
  (
    {
      data,
      direction = 'top-down',
