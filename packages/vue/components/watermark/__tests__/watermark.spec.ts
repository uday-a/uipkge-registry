...
describe("Watermark", () => {
  ...
  it("has data-uipkge on container", () => {
    ...
    expect(
      w.find('[data-slot="watermark"]').attributes("data-uipkge"),
    ).toBeDefined();
    w.unmount();
  });
  ...
  it("overlay has data-uipkge", () => {
    ...
    expect(
      w.find('[data-slot="watermark-overlay"]').attributes("data-uipkge"),
    ).toBeDefined();
    w.unmount();
  });
  ...
  it('overlay has aria-hidden="true"', () => {
    ...
    expect(
      w.find('[data-slot="watermark-overlay"]').attributes("aria-hidden"),
    ).toBe("true");
    w.unmount();
  });
