...
describe('Highlight', () => {
  it('renders with data-slot="highlight"', () => {
    const w = mount(Highlight, { props: { text: 'hello world', query: 'world' }, attachTo: document.body })
    expect(w.find('[data-slot="highlight"]').exists()).toBe(true)
    w.unmount()
  })

  it('has data-uipkge', () => {
    const w = mount(Highlight, { props: { text: 'hello', query: 'ell' }, attachTo: document.body })
  ...
  it('renders as a span', () => {
    const w = mount(Highlight, { props: { text: 'hello', query: 'ell' }, attachTo: document.body })
    expect(w.find('[data-slot="highlight"]').element.tagName.toLowerCase()).toBe('span')
    w.unmount()
  })

  it('renders the full text content', () => {
    const w = mount(Highlight, { props: { text: 'hello world', query: 'xyz' }, attachTo: document.body })
  ...
  it('caps highlights at maxHighlights', () => {
    const w = mount(Highlight, { props: { text: 'a a a', query: 'a', maxHighlights: 2 }, attachTo: document.body })
