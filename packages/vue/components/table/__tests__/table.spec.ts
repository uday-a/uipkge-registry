...
describe("Table", () => {
  ...
  it("has data-uipkge on table element", () => {
    const w = mountTable();
    expect(
      w.find('[data-slot="table"]').attributes("data-uipkge"),
    ).toBeDefined();
    w.unmount();
  });
  ...
  it("all sub-components have data-uipkge", () => {
    const w = mountTable();
    expect(
      w.find('[data-slot="table-header"]').attributes("data-uipkge"),
    ).toBeDefined();
    expect(
      w.find('[data-slot="table-body"]').attributes("data-uipkge"),
    ).toBeDefined();
    expect(
      w.find('[data-slot="table-row"]').attributes("data-uipkge"),
    ).toBeDefined();
    expect(
      w.find('[data-slot="table-head"]').attributes("data-uipkge"),
    ).toBeDefined();
    expect(
      w.find('[data-slot="table-cell"]').attributes("data-uipkge"),
    ).toBeDefined();
    w.unmount();
  });
});
