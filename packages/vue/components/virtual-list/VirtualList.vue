...
const viewportSize = ref(
  typeof props.height === 'number' ? props.height : Number.parseInt(String(props.height), 10) || 0,
)
...
function measure() {
  ...
  const measured = isVertical.value ? scrollEl.value.clientHeight : scrollEl.value.clientWidth
  const fallback = typeof props.height === 'number' ? props.height : Number.parseInt(String(props.height), 10) || 0
