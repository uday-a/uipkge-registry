...
describe('Tooltip', () => {
  ...
  it('TooltipTrigger renders as a button when used as child of Tooltip', () => {
    ...
    expect(w.find('[data-slot="tooltip-trigger"]').element.tagName.toLowerCase()).toBe('button')
    w.unmount()
  })
  ...
  it('TooltipContent has data-uipkge', async () => {
    ...
    await flushPromises()
    expect(document.querySelector('[data-slot="tooltip-content"]')?.getAttribute('data-uipkge')).toBeDefined()
    w.unmount()
  })
  ...
  it('TooltipContent renders slot content', async () => {
    ...
    await flushPromises()
    expect(document.querySelector('[data-slot="tooltip-content"]')?.textContent).toContain('My Tooltip Text')
    w.unmount()
  })
  ...
  it('TooltipContent has role="tooltip"', async () => {
    ...
    await flushPromises()
    expect(document.querySelector('[data-slot="tooltip-content"] [role="tooltip"]')).toBeTruthy()
    w.unmount()
  })
