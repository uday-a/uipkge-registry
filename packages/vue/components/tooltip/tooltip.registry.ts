...
export default defineRegistryItem({
  ...
  files: [
    ...
    { path: 'TooltipContent.vue', target: 'components/ui/tooltip/TooltipContent.vue' },
    { path: 'TooltipProvider.vue', target: 'components/ui/tooltip/TooltipProvider.vue' },
    { path: 'TooltipTrigger.vue', target: 'components/ui/tooltip/TooltipTrigger.vue' },
