...
export default defineRegistryItem({
  ...
  files: [
    ...
    { path: 'SkeletonGroup.vue', target: 'components/ui/skeleton/SkeletonGroup.vue' },
    { path: 'SkeletonLoader.vue', target: 'components/ui/skeleton/SkeletonLoader.vue' },
    { path: 'SkeletonText.vue', target: 'components/ui/skeleton/SkeletonText.vue' },
