...
describe('Textarea', () => {
  ...
  it('renders placeholder', () => {
    const w = mount(Textarea, { props: { modelValue: '', placeholder: 'Enter text' } })
    expect(w.find('textarea').attributes('placeholder')).toBe('Enter text')
    w.unmount()
  })

  it('renders label text', () => {
    const w = mount(Textarea, { props: { modelValue: '', label: 'Description' } })
  ...
  it('renders error messages', () => {
    const w = mount(Textarea, { props: { modelValue: '', errorMessages: 'Required field' } })
  ...
  it('shows required indicator in label', () => {
    const w = mount(Textarea, { props: { modelValue: '', label: 'Bio', required: true } })
  ...
  it('clears value when allowClear button is clicked', async () => {
    const w = mount(Textarea, { props: { modelValue: 'text', allowClear: true } })
