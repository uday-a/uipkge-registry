...
export default defineRegistryItem({
  ...
  files: [
    { path: 'TimeColumns.vue', target: 'components/ui/time-picker/TimeColumns.vue' },
    { path: 'TimePicker.vue', target: 'components/ui/time-picker/TimePicker.vue' },
    { path: 'TimeRangePicker.vue', target: 'components/ui/time-picker/TimeRangePicker.vue' },
