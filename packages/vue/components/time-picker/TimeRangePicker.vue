...
const display = computed(() => {
  ...
  const startStr = hasStart
    ? formatDisplay(
        startParsed.value!.hour24,
        startParsed.value!.minute,
        startParsed.value!.second,
      )
    : "";
  const endStr = hasEnd
    ? formatDisplay(
        endParsed.value!.hour24,
        endParsed.value!.minute,
        endParsed.value!.second,
      )
    : "";
    ...
    <PopoverContent class="w-auto p-0" align="start">
      ...
      <div class="flex">
        <div class="flex flex-col">
          <div
            class="text-muted-foreground border-b px-3 py-1.5 text-center text-xs font-medium"
          >
            Start
          </div>
          <TimeColumns
