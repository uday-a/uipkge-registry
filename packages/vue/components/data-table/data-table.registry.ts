...
export default defineRegistryItem({
  ...
  files: [
    ...
    {
      path: "DataTableColumnHeader.vue",
      target: "components/ui/data-table/DataTableColumnHeader.vue",
    },
    {
      path: "DataTableFilterPopover.vue",
      target: "components/ui/data-table/DataTableFilterPopover.vue",
    },
    {
      path: "DataTableFilterSheet.vue",
      target: "components/ui/data-table/DataTableFilterSheet.vue",
    },
    {
      path: "DataTablePagination.vue",
      target: "components/ui/data-table/DataTablePagination.vue",
    },
    {
      path: "DataTableToolbar.vue",
      target: "components/ui/data-table/DataTableToolbar.vue",
    },
