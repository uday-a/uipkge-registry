...
onBeforeUnmount(() => {
  if (svg.value && wheelHandler) svg.value.removeEventListener('wheel', wheelHandler)
})
</script>
...
<template>
  ...
  >
    ...
    <text v-if="showValue" x="50" y="55" text-anchor="middle" font-size="18" class="fill-foreground font-medium">
