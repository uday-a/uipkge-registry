...
export default defineRegistryItem({
  ...
  files: [
    ...
    { path: 'BoardLaneHeader.vue', target: 'components/ui/board/BoardLaneHeader.vue' },
    { path: 'BoardLaneBody.vue', target: 'components/ui/board/BoardLaneBody.vue' },
    { path: 'BoardLaneEmpty.vue', target: 'components/ui/board/BoardLaneEmpty.vue' },
