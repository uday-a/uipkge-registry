...
export default defineRegistryItem({
  ...
  files: [
    { path: 'AdvanceSelect.vue', target: 'components/ui/advance-select/AdvanceSelect.vue' },
    { path: 'CommandSearchSync.vue', target: 'components/ui/advance-select/CommandSearchSync.vue' },
