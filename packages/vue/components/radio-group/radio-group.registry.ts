...
export default defineRegistryItem({
  ...
  files: [
    { path: 'RadioGroup.vue', target: 'components/ui/radio-group/RadioGroup.vue' },
    { path: 'RadioGroupItem.vue', target: 'components/ui/radio-group/RadioGroupItem.vue' },
    { path: 'RadioButton.vue', target: 'components/ui/radio-group/RadioButton.vue' },
