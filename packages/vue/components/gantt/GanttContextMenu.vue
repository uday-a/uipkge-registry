      ...
      <ContextMenuSub>
        ...
        <ContextMenuSubContent class="w-44">
          <ContextMenuRadioGroup :model-value="task.status ?? 'todo'">
            <ContextMenuRadioItem
              value="done"
              @select="$emit('status-change', task, 'done')"
            >
            ...
            <ContextMenuRadioItem
              value="in-progress"
              @select="$emit('status-change', task, 'in-progress')"
            >
            ...
            <ContextMenuRadioItem
              value="at-risk"
              @select="$emit('status-change', task, 'at-risk')"
            >
            ...
            <ContextMenuRadioItem
              value="blocked"
              @select="$emit('status-change', task, 'blocked')"
            >
            ...
            <ContextMenuRadioItem
              value="todo"
              @select="$emit('status-change', task, 'todo')"
            >
      ...
      <ContextMenuSub>
        ...
        <ContextMenuSubContent class="w-40">
          <ContextMenuRadioGroup :model-value="task.priority ?? 'medium'">
            <ContextMenuRadioItem
              value="urgent"
              @select="$emit('priority-change', task, 'urgent')"
            >
            ...
            <ContextMenuRadioItem
              value="high"
              @select="$emit('priority-change', task, 'high')"
            >
            ...
            <ContextMenuRadioItem
              value="medium"
              @select="$emit('priority-change', task, 'medium')"
            >
            ...
            <ContextMenuRadioItem
              value="low"
              @select="$emit('priority-change', task, 'low')"
            >
