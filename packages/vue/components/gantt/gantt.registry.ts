...
export default defineRegistryItem({
  ...
  files: [
    ...
    { path: 'GanttTimeline.vue', target: 'components/ui/gantt/GanttTimeline.vue' },
    { path: 'GanttBar.vue', target: 'components/ui/gantt/GanttBar.vue' },
    { path: 'GanttMilestone.vue', target: 'components/ui/gantt/GanttMilestone.vue' },
    { path: 'GanttContextMenu.vue', target: 'components/ui/gantt/GanttContextMenu.vue' },
