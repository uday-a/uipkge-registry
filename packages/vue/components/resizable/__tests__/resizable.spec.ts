...
describe('Resizable', () => {
  ...
  it('ResizablePanelGroup has data-uipkge', () => {
    const w = mountResizable()
    expect(w.find('[data-slot="resizable-panel-group"]').attributes('data-uipkge')).toBeDefined()
    w.unmount()
  })
  ...
  it('ResizablePanel has data-uipkge', () => {
    const w = mountResizable()
    expect(w.find('[data-slot="resizable-panel"]').attributes('data-uipkge')).toBeDefined()
    w.unmount()
  })
  ...
  it('ResizableHandle has data-uipkge', () => {
    const w = mountResizable()
    expect(w.find('[data-slot="resizable-handle"]').attributes('data-uipkge')).toBeDefined()
    w.unmount()
  })
  ...
  it('ResizablePanelGroup applies data-orientation', () => {
    const w = mountResizable()
    expect(w.find('[data-slot="resizable-panel-group"]').attributes('data-orientation')).toBeDefined()
    w.unmount()
  })
})
