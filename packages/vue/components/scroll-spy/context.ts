...
export const SCROLL_SPY_CONTEXT_KEY: InjectionKey<ScrollSpyContext> = Symbol(
  "uipkge-scroll-spy-context",
);
export const SCROLL_SPY_ITEM_DEPTH_KEY: InjectionKey<Ref<number>> = Symbol(
  "uipkge-scroll-spy-depth",
);
