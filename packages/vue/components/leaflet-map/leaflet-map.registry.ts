...
export default defineRegistryItem({
  ...
  files: [
    { path: 'LeafletMap.vue', target: 'components/ui/leaflet-map/LeafletMap.vue' },
    { path: 'LeafletMarker.vue', target: 'components/ui/leaflet-map/LeafletMarker.vue' },
    { path: 'LeafletPopup.vue', target: 'components/ui/leaflet-map/LeafletPopup.vue' },
    { path: 'LeafletTooltip.vue', target: 'components/ui/leaflet-map/LeafletTooltip.vue' },
    { path: 'LeafletPolyline.vue', target: 'components/ui/leaflet-map/LeafletPolyline.vue' },
    { path: 'LeafletPolygon.vue', target: 'components/ui/leaflet-map/LeafletPolygon.vue' },
    { path: 'LeafletCircle.vue', target: 'components/ui/leaflet-map/LeafletCircle.vue' },
    { path: 'LeafletCircleMarker.vue', target: 'components/ui/leaflet-map/LeafletCircleMarker.vue' },
    { path: 'LeafletGeoJson.vue', target: 'components/ui/leaflet-map/LeafletGeoJson.vue' },
    { path: 'LeafletTileLayer.vue', target: 'components/ui/leaflet-map/LeafletTileLayer.vue' },
