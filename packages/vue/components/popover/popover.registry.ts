...
export default defineRegistryItem({
  ...
  files: [
    ...
    { path: 'PopoverAnchor.vue', target: 'components/ui/popover/PopoverAnchor.vue' },
    { path: 'PopoverContent.vue', target: 'components/ui/popover/PopoverContent.vue' },
    { path: 'PopoverTrigger.vue', target: 'components/ui/popover/PopoverTrigger.vue' },
