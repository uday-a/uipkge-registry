...
export default defineRegistryItem({
  ...
  files: [
    ...
    { path: 'PinInputGroup.vue', target: 'components/ui/pin-input/PinInputGroup.vue' },
    { path: 'PinInputSeparator.vue', target: 'components/ui/pin-input/PinInputSeparator.vue' },
    { path: 'PinInputSlot.vue', target: 'components/ui/pin-input/PinInputSlot.vue' },
