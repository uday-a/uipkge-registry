...
describe('Questionnaire', () => {
  it('renders with data-slot="questionnaire"', () => {
    const w = mount(Questionnaire, { props: { items }, attachTo: document.body })
  ...
  it('shows question 1 of 2', () => {
    const w = mount(Questionnaire, { props: { items }, attachTo: document.body })
    expect(w.find('[data-slot="questionnaire-progress"]').text()).toContain('Question 1 of 2')
    w.unmount()
  })

  it('hides progress when showProgress is false', () => {
    const w = mount(Questionnaire, { props: { items, showProgress: false }, attachTo: document.body })
  ...
  it('advances after a choice', async () => {
    ...
    await w.find('[data-slot="questionnaire-next"]').trigger('click')
    expect(w.find('[data-slot="questionnaire-progress"]').text()).toContain('Question 2 of 2')
