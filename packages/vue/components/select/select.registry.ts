...
export default defineRegistryItem({
  ...
  files: [
    ...
    { path: "SelectValue.vue", target: "components/ui/select/SelectValue.vue" },
    {
      ...
      target: "components/ui/select/NativeSelect.vue",
    },
