...
describe('Select', () => {
  ...
  it('applies size data attribute on trigger', () => {
    ...
    expect(w.find('[data-slot="select-trigger"]').attributes('data-size')).toBe('lg')
    w.unmount()
  })
  ...
  it('applies state data attribute on trigger', () => {
    ...
    expect(w.find('[data-slot="select-trigger"]').attributes('data-state-value')).toBe('error')
    w.unmount()
  })
  ...
  it('shows loading state when loading is true', () => {
    ...
    expect(w.find('[data-slot="select-trigger"]').attributes('aria-busy')).toBe('true')
    w.unmount()
  })
  ...
  it('disables trigger when disabled prop is set', () => {
    ...
    expect(w.find('[data-slot="select-trigger"]').attributes('disabled')).toBeDefined()
    w.unmount()
  })
