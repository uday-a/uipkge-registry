...
export default defineRegistryItem({
  ...
  files: [
    {
      path: "OrganizationChart.vue",
      target: "components/ui/organization-chart/OrganizationChart.vue",
    },
    {
      path: "OrgChartNode.vue",
      target: "components/ui/organization-chart/OrgChartNode.vue",
    },
    {
