...
export default defineRegistryItem({
  ...
  files: [
    ...
    { path: 'HoverCardContent.vue', target: 'components/ui/hover-card/HoverCardContent.vue' },
    { path: 'HoverCardTrigger.vue', target: 'components/ui/hover-card/HoverCardTrigger.vue' },
