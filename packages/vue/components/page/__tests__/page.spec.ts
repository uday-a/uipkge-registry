...
describe('Page', () => {
  ...
  it('renders slot content', () => {
    const w = mount(Page, { slots: { default: '<p>Body</p>' }, attachTo: document.body })
...
describe('PageHeader', () => {
  ...
  it('renders default slot content', () => {
    const w = mount(PageHeader, { slots: { default: '<span>Heading</span>' }, attachTo: document.body })
    expect(w.text()).toContain('Heading')
    w.unmount()
  })

  it('renders actions slot content', () => {
    const w = mount(PageHeader, { slots: { actions: '<button>Action</button>' }, attachTo: document.body })
...
describe('PageHeaderHeading', () => {
  it('renders with data-slot="page-header-heading"', () => {
    const w = mount(PageHeaderHeading, { props: { title: 'My Title' }, attachTo: document.body })
  ...
  it('renders description when provided', () => {
    const w = mount(PageHeaderHeading, { props: { title: 'T', description: 'Desc' }, attachTo: document.body })
