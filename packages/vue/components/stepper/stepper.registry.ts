...
export default defineRegistryItem({
  ...
  files: [
    ...
    {
      path: "StepperItem.vue",
      target: "components/ui/stepper/StepperItem.vue",
    },
    {
      path: "StepperIndicator.vue",
      target: "components/ui/stepper/StepperIndicator.vue",
    },
    {
      path: "StepperHeader.vue",
      target: "components/ui/stepper/StepperHeader.vue",
    },
    {
      path: "StepperContent.vue",
      target: "components/ui/stepper/StepperContent.vue",
    },
    {
      path: "StepperTitle.vue",
      target: "components/ui/stepper/StepperTitle.vue",
    },
    {
      path: "StepperDescription.vue",
      target: "components/ui/stepper/StepperDescription.vue",
    },
    {
      path: "StepperStep.vue",
      target: "components/ui/stepper/StepperStep.vue",
    },
    { path: "context.ts", target: "components/ui/stepper/context.ts" },
    {
      path: "stepper.variants.ts",
