...
<template>
  ...
  >
    <div class="flex flex-wrap items-center gap-4">
      ...
      <HoverCard :open-delay="700" :close-delay="200">
        <HoverCardTrigger as-child>
      ...
      <HoverCard :open-delay="1500" :close-delay="500">
        <HoverCardTrigger as-child>
  ...
  >
    <p class="max-w-prose text-sm leading-7">
      ...
      <HoverCard>
        <HoverCardTrigger as-child>
          <Button variant="link" class="h-auto px-0 py-0 align-baseline"
            >@nuxt</Button
          >
        </HoverCardTrigger>
  ...
  >
    <div
      class="grid grid-cols-2 place-items-center gap-x-12 gap-y-6 py-12 sm:grid-cols-4"
    >
      <HoverCard
      ...
      >
        ...
        <HoverCardContent :side="side" class="w-48">
