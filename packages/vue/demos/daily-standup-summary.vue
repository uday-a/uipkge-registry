...
import DailyStandupSummary, {
  type BlockerAlert,
  type StandupMember,
  type StandupPulseMetrics,
} from '@/components/blocks/daily-standup-summary/DailyStandupSummary.vue'
...
<template>
  ...
  >
    <DailyStandupSummary
      ...
      date="Today · Friday, Aug 21, 2026"
      :pulse-metrics="emergencyPulse"
      :blocker-alert="emergencyBlocker"
    />
  </Story>
  ...
  >
    <DailyStandupSummary initial-filter="blocked" />
  </Story>
  ...
  >
    <DailyStandupSummary initial-filter="needs-review" />
  </Story>
</template>
