...
import AiCrmPipelineDashboard from '@/components/blocks/ai-crm-pipeline-dashboard/AiCrmPipelineDashboard.vue'
</script>
...
<template>
  ...
  >
    <AiCrmPipelineDashboard initial-view-mode="table" />
  </Story>
  ...
  >
    <AiCrmPipelineDashboard initial-stage-filter="negotiation" />
  </Story>
  ...
  >
    <AiCrmPipelineDashboard initial-search="Fintech" />
  </Story>
  ...
  >
    <AiCrmPipelineDashboard :show-insights="false" />
  </Story>
</template>
