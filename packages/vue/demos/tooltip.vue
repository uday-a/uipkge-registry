...
import { Bell, Copy, Eye, EyeOff, GitBranch, Settings, Trash2 } from 'lucide-vue-next'
    ...
    >
      <div class="flex flex-wrap gap-3">
        <TooltipProvider :delay-duration="0">
          <Tooltip>
            <TooltipTrigger as-child><Button variant="outline" size="sm">Instant</Button></TooltipTrigger>
        ...
        <TooltipProvider :delay-duration="700">
          <Tooltip>
            <TooltipTrigger as-child><Button variant="outline" size="sm">Slow</Button></TooltipTrigger>
