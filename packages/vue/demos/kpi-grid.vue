...
import { Activity, Briefcase, CalendarClock, DollarSign, TrendingUp, UserCheck, Users } from 'lucide-vue-next'
...
<template>
  ...
  >
    <KpiGrid>
      <Card class="flex flex-col justify-between">
        <CardHeader class="flex flex-row items-center justify-between pb-2">
          <CardTitle class="text-muted-foreground text-xs font-medium tracking-widest uppercase"
            >TOTAL EMPLOYEES</CardTitle
          >
          <div class="bg-primary/10 text-primary/70 rounded-lg p-2"><Users class="size-4" aria-hidden="true" /></div>
        </CardHeader>
        <CardContent>
      ...
      <Card class="flex flex-col justify-between">
        <CardHeader class="flex flex-row items-center justify-between pb-2">
          <CardTitle class="text-muted-foreground text-xs font-medium tracking-widest uppercase">ACTIVE</CardTitle>
      ...
      <Card>
        <CardHeader class="flex flex-row items-center justify-between pb-2">
          <CardTitle class="text-muted-foreground text-xs font-medium tracking-widest uppercase">ON LEAVE</CardTitle>
          <CalendarClock class="text-muted-foreground size-4" aria-hidden="true" />
        </CardHeader>
        <CardContent><div class="text-2xl font-bold tracking-tight">5</div></CardContent>
      </Card>

      <Card>
        <CardHeader class="flex flex-row items-center justify-between pb-2">
          <CardTitle class="text-muted-foreground text-xs font-medium tracking-widest uppercase">TERMINATED</CardTitle>
          <Briefcase class="text-muted-foreground size-4" aria-hidden="true" />
        </CardHeader>
        <CardContent><div class="text-2xl font-bold tracking-tight">3</div></CardContent>
      </Card>
    </KpiGrid>
  </Story>
  ...
  <Story title="Three columns" description="Use the columns prop to change density. Accepts 2, 3, or 4.">
    <KpiGrid :columns="3">
      <Card class="flex flex-col justify-between">
        <CardHeader class="flex flex-row items-center justify-between pb-2">
          <CardTitle class="text-muted-foreground text-xs font-medium tracking-widest uppercase">REVENUE</CardTitle>
          <DollarSign class="text-muted-foreground size-4" aria-hidden="true" />
        </CardHeader>
        <CardContent><div class="text-2xl font-bold tracking-tight">$1.2M</div></CardContent>
        <div class="flex items-center justify-end gap-1.5 px-6 pb-4 text-xs">
          <span class="bg-success/10 text-success inline-flex items-center rounded-full px-1.5 py-0.5 font-medium"
            >+8.4%</span
          >
      ...
      <Card class="flex flex-col justify-between">
        <CardHeader class="flex flex-row items-center justify-between pb-2">
          <CardTitle class="text-muted-foreground text-xs font-medium tracking-widest uppercase">CONVERSION</CardTitle>
          <TrendingUp class="text-muted-foreground size-4" aria-hidden="true" />
        </CardHeader>
        <CardContent><div class="text-2xl font-bold tracking-tight">3.7%</div></CardContent>
        <div class="flex items-center justify-end gap-1.5 px-6 pb-4 text-xs">
          <span class="bg-success/10 text-success inline-flex items-center rounded-full px-1.5 py-0.5 font-medium"
            >+0.6pp</span
          >
      ...
      <Card class="flex flex-col justify-between">
        <CardHeader class="flex flex-row items-center justify-between pb-2">
          ...
          >
          <Activity class="text-muted-foreground size-4" aria-hidden="true" />
        </CardHeader>
        <CardContent><div class="text-2xl font-bold tracking-tight">8,412</div></CardContent>
        <div class="flex items-center justify-end gap-1.5 px-6 pb-4 text-xs">
          <span
  ...
  >
    <KpiGrid>
      <Card>
        ...
        <CardContent>
          <div class="text-2xl font-bold tracking-tight">124</div>
          <Sparkline :data="headcount" :height="36" class="mt-2" />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader class="flex flex-row items-center justify-between pb-2">
          <CardTitle class="text-muted-foreground text-xs font-medium tracking-widest uppercase">ACTIVE</CardTitle>
          <UserCheck class="text-muted-foreground size-4" aria-hidden="true" />
        </CardHeader>
        <CardContent><div class="text-2xl font-bold tracking-tight">116</div></CardContent>
      </Card>
    </KpiGrid>
  </Story>
  ...
  >
    <KpiGrid>
      ...
      <Card>
        <CardHeader class="pb-1">
          <CardTitle class="text-muted-foreground text-xs font-medium tracking-widest uppercase">CONVERSIONS</CardTitle>
      ...
      <Card>
        <CardHeader class="pb-1">
          <CardTitle class="text-muted-foreground text-xs font-medium tracking-widest uppercase">CHURN</CardTitle>
