...
const options3 = computed<MentionOption[]>(() =>
  /[#]\w*$/.test(text3.value) ? channels : users,
);
...
<template>
  ...
  >
    <div class="space-y-2">
      <Mentions
        ...
        :options="options3"
        :format="
          (opt: MentionOption, trigger: string) => trigger + opt.value + ' '
        "
  ...
  <Story
    ...
    description="Options with avatar + description render in two lines."
  >
    <div class="space-y-2">
      <Mentions
        v-model="text4"
