...
<template>
  ...
  >
    <div class="max-w-xl space-y-4">
      <div
        class="border-border bg-card space-y-3 rounded-xl border p-4 shadow-xs"
      >
        ...
        <div
          class="border-border/50 text-muted-foreground flex items-center gap-2 border-t pt-2 text-xs"
        >
          <span>Tags:</span>
          <MentionTag
            trigger="#"
