...
import ServiceHealthMatrix from '@/components/blocks/service-health-matrix/ServiceHealthMatrix.vue'
import type {
  RegionHealth,
  ServiceHealthItem,
  IncidentRecord,
  DayStatus,
} from '@/components/blocks/service-health-matrix/ServiceHealthMatrix.vue'
...
<template>
  ...
  >
    <ServiceHealthMatrix system-status="degraded" system-uptime="99.42%" :regions="degradedRegions" />
  </Story>
  ...
  >
    <ServiceHealthMatrix system-status="maintenance" system-uptime="99.95%" :services="maintenanceServices" />
  </Story>
  ...
  >
    <ServiceHealthMatrix system-status="operational" system-uptime="100.0%" :services="cleanServices" :incidents="[]" />
  </Story>
</template>
