...
import BillingUsageCenter from '@/components/blocks/billing-usage-center/BillingUsageCenter.vue'
...
<template>
  ...
  <Story title="Near-limit usage" description="Bars shift to warning as metrics close in on their included allowance.">
  ...
  <Story title="Many invoices" description="Eight cycles of history; the unpaid banner stays pinned above the table.">
