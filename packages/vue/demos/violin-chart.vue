...
<template>
  ...
  <Story
    title="Two-gateway compare"
    description="Narrow violins mean consistent handling; wide ones mean variance to chase."
  >
    <ViolinChart :groups="gateways.slice(0, 2)" height="340" />
  </Story>
</template>
