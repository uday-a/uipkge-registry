...
import MatrixSwotAnalysis, {
  type SwotItem,
  type StrategicInitiative,
} from '@/components/blocks/matrix-swot-analysis/MatrixSwotAnalysis.vue'
...
<template>
  ...
  >
    <MatrixSwotAnalysis
      ...
      :initial-strengths="infraStrengths"
      :initial-weaknesses="infraWeaknesses"
      :initial-opportunities="infraOpportunities"
      :initial-threats="infraThreats"
  ...
  >
    <MatrixSwotAnalysis
      ...
      :initial-strengths="aiStrengths"
      :initial-weaknesses="aiWeaknesses"
      :initial-opportunities="aiOpportunities"
      :initial-threats="aiThreats"
