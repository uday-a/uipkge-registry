...
<template>
  ...
  >
    <div class="max-w-md space-y-3">
      <ProgressItem
        label="Healthy"
        :value="76"
        bar-class="[&_[data-slot=progress-indicator]]:bg-emerald-500"
      />
      <ProgressItem
        label="At risk"
        :value="48"
        bar-class="[&_[data-slot=progress-indicator]]:bg-amber-500"
      />
      <ProgressItem
        label="Critical"
        :value="22"
        bar-class="[&_[data-slot=progress-indicator]]:bg-red-500"
      />
    </div>
  </Story>
  ...
  >
    <div class="max-w-md space-y-3">
      <ProgressItem
        ...
        :value="62"
        secondary-label="124 / 200"
        :color-index="1"
      />
      <ProgressItem
        label="Storage used"
        :value="34"
        secondary-label="3.4 GB / 10 GB"
        :color-index="2"
      />
      <ProgressItem
        label="Time elapsed"
        :value="80"
        secondary-label="48m left"
        :color-index="3"
      />
    </div>
  </Story>
  ...
  >
    <div class="grid max-w-2xl grid-cols-2 gap-x-6 gap-y-3">
      <ProgressItem label="API uptime" :value="99" :color-index="0" />
      <ProgressItem label="DB uptime" :value="97" :color-index="1" />
      <ProgressItem label="Cache hit rate" :value="84" :color-index="2" />
      <ProgressItem label="Error budget" :value="62" :color-index="3" />
      <ProgressItem
        label="P95 latency"
        :value="78"
        secondary-label="78ms"
        :color-index="4"
      />
      <ProgressItem
        label="Throughput"
        :value="55"
        secondary-label="5.5k/s"
        :color-index="5"
      />
    </div>
  </Story>
