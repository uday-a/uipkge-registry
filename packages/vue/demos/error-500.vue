...
import Error500 from '@/components/blocks/error-500/Error500.vue'
</script>
...
<template>
  ...
  <Story title="Custom copy" description="title, description, and code rewrite the incident for a named outage.">
    <Error500
      ...
      primary-label="Retry checkout"
      secondary-label="Status page"
      tertiary-label="Email on-call"
    />
  </Story>
