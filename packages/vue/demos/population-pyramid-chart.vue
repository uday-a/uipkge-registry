...
import { PopulationPyramidChart } from "@/components/ui/charts";
...
<template>
  <Story
    title="User age split"
    description="Mirrored bars; tooltips and labels show absolute values."
  >
  ...
  <Story
    ...
    description="Rename the sides for any A/B population."
  >
