...
const skills = [
  ...
  { name: "ECharts", value: 76 },
  { name: "Reka UI", value: 64 },
  { name: "Radix", value: 52 },
  { name: "Astro", value: 41 },
];
</script>
...
<template>
  <Story
    title="Docs topics"
    description="Frequency-sized words from the chart palette. Hover to emphasise."
  >
  ...
  <Story
    title="Skill cloud"
    description="Same wrapper for profile and tag surfaces."
  >
    <WordCloudChart :data="skills" height="240" />
  </Story>
</template>
