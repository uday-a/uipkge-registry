...
import { GanttChart } from '@/components/ui/charts'
...
<template>
  ...
  <Story title="Machine schedule" description="Groups share palette slots automatically.">
    <GanttChart
      :tasks="[
        { name: 'Press A', start: '2026-09-05', end: '2026-09-09', progress: 1, group: 'Line 1' },
        { name: 'Press B', start: '2026-09-07', end: '2026-09-14', progress: 0.5, group: 'Line 2' },
      ]"
      height="200"
    />
  </Story>
  ...
  <Story title="Today line" description="Dashed reference for the current date (pass explicitly for SSR-safe renders).">
    <GanttChart :tasks="launch" today="2026-09-25" height="300" />
  </Story>
