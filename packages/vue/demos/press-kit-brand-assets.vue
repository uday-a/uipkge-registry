...
import PressKitBrandAssets, {
  type BrandColor,
  type Executive,
  type LogoAsset,
} from '@/components/blocks/press-kit-brand-assets/PressKitBrandAssets.vue'
...
<template>
  ...
  >
    <PressKitBrandAssets
      ...
      press-email="press@aethercloud.io"
      press-kit-zip-size="64 MB"
      fact-sheet-pdf-size="3.8 MB"
      boilerplate-text="Aether Cloud is the high-performance edge compute platform powering real-time AI and collaborative applications for modern engineering teams."
      :colors="customColors"
  ...
  >
    <div class="rounded-xl bg-zinc-950 p-6 text-zinc-100">
      <PressKitBrandAssets />
    </div>
  </Story>
</template>
