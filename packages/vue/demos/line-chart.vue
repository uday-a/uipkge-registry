...
<template>
  ...
  >
    <LineChart :data="traffic" x-field="day" y-field="sessions" height="280" />
  </Story>

  <Story title="Multi-series" description="Pass an array to y-field for parallel series; legend renders automatically.">
    <LineChart :data="traffic" x-field="day" :y-field="['sessions', 'signups']" height="300" />
  </Story>
  ...
  >
    <LineChart :data="traffic" x-field="day" :y-field="['sessions', 'signups']" :option="smoothOption" height="300" />
  </Story>
  ...
  >
    <LineChart :data="traffic" x-field="day" :y-field="['sessions', 'signups']" :option="dashedOption" height="300" />
  </Story>
  ...
  >
    <LineChart :data="traffic" x-field="day" y-field="sessions" :option="steppedOption" height="280" />
  </Story>
  ...
  >
    <LineChart :data="traffic" x-field="day" y-field="sessions" :option="markersOption" height="280" />
  </Story>

  <Story title="Linear curves" description="Straight segments via the curve prop — no option override needed.">
    <LineChart :data="traffic" x-field="day" :y-field="['sessions', 'signups']" curve="linear" height="300" />
  </Story>

  <Story title="Step start" description="Step interpolation flavours (step, stepStart, stepEnd) for discrete metrics.">
    <LineChart :data="traffic" x-field="day" y-field="sessions" curve="stepStart" height="280" />
  </Story>

  <Story title="Stacked lines" description="Cumulative stacking as a first-class prop.">
    <LineChart :data="traffic" x-field="day" :y-field="['sessions', 'signups']" :stacked="true" height="300" />
  </Story>

  <Story title="Dashed forecast" description="Dashed stroke plus hidden markers reads as projection.">
    <LineChart :data="traffic" x-field="day" y-field="sessions" :dashed="true" :markers="false" height="280" />
  </Story>
  ...
  >
    <LineChart :data="cargoDemand" x-field="m" :y-field="['flown', 'forecast']" :option="peakOption" height="320" />
  </Story>
  ...
  >
    <LineChart :data="spotRates" x-field="m" y-field="tpeb" :option="cnyOption" height="300" />
  </Story>
  ...
  >
    <LineChart :data="spotRates" x-field="m" y-field="fewb" :option="changeOption" height="300" />
  </Story>
</template>
