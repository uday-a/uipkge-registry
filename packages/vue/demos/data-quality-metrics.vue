...
import DataQualityMetrics from '@/components/blocks/data-quality-metrics/DataQualityMetrics.vue'
import type { AssertionItem } from '@/components/blocks/data-quality-metrics/DataQualityMetrics.vue'
...
<template>
  ...
  >
    <DataQualityMetrics
      dataset-title="warehouse.fct_orders_daily"
      suite-name="financial_transactions_strict_v2"
      :quality-score="100"
      last-run="Ran 6m ago · 32 assertions evaluated"
      passed-assertions="32 / 32 Passing · 100%"
      failed-warnings="0 Warnings · Clean run"
      schema-drift-status="0 breaking schema changes"
      total-rows-audited="4,820,000 rows"
