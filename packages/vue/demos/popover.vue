...
<template>
    ...
    <div class="flex flex-wrap items-center gap-3">
      ...
      <Popover>
        <PopoverTrigger as-child
          ...
          ></PopoverTrigger
        >
        <PopoverContent side="right" align="center" class="w-44"
          >Centered on the right side.</PopoverContent
        >
      </Popover>
      <Popover>
        <PopoverTrigger as-child
        ...
        <PopoverContent side="bottom" align="end" class="w-44"
          >Aligned to the end of the bottom edge.</PopoverContent
        >
      </Popover>
    </div>
  </Story>
    ...
    <div class="flex items-center gap-3">
      <Popover v-model:open="open">
        ...
        <PopoverContent class="w-64 text-sm">
          ...
          <Button size="sm" variant="outline" class="mt-3" @click="open = false"
            >Close</Button
          >
        </PopoverContent>
      </Popover>
  ...
  >
    <Popover close-behavior="click-outside">
      ...
      <PopoverContent
        >Press Escape - nothing happens. Click outside - I
        close.</PopoverContent
      >
    </Popover>
  </Story>
</template>
