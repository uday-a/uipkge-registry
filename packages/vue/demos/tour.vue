...
<template>
  ...
  >
    <div class="space-y-4">
      ...
      <Tour v-model:open="open2" v-model:current="step2" :steps="steps2" type="primary" />
    </div>
  </Story>

  <Story title="Centered (no target) step" description="A step with no target renders as a centered modal-style card.">
    <div class="space-y-4">
