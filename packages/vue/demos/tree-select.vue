...
<template>
  ...
  >
    <div class="max-w-md space-y-2">
      <TreeSelect v-model="fileValue" :data="fileTree" placeholder="Select a file..." class="w-full" />
  ...
  >
    <div class="max-w-md space-y-2">
      <TreeSelect v-model="multiValue" :data="fileTree" multiple placeholder="Select files..." class="w-full" />
  ...
  <Story title="Size variants" description="Small, default, and large triggers side by side for comparison.">
    <div class="max-w-md space-y-3">
      <TreeSelect v-model="smValue" :data="fileTree" size="sm" placeholder="Small..." class="w-full" />
      <TreeSelect :data="fileTree" placeholder="Default..." class="w-full" />
      <TreeSelect v-model="lgValue" :data="fileTree" size="lg" placeholder="Large..." class="w-full" />
    </div>
  </Story>
