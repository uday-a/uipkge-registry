...
const quarterData = yearData.filter(
  ([iso]) => iso >= "2026-03-01" && iso <= "2026-05-15",
);
...
const monthData = yearData.filter(
  ([iso]) => iso >= "2026-05-01" && iso <= "2026-05-31",
);
