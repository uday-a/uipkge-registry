...
<template>
  ...
  >
    <CalendarHeatmap :data="yearData" :range="yearRange" :color-range="['#ccfbf1', '#0f766e']" height="200" />
  </Story>

  <Story title="Blue palette" description="GitHub-style blues. Goes well with dark themes.">
    <CalendarHeatmap :data="yearData" :range="yearRange" :color-range="['#dbeafe', '#1d4ed8']" height="200" />
  </Story>
  ...
  >
    <CalendarHeatmap :data="opsData" :range="opsRange" :color-range="['#dcfce7', '#15803d']" height="200" />
  </Story>
</template>
