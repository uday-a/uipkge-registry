...
import NeighborhoodWalkscoreCard from '@/components/blocks/neighborhood-walkscore-card/NeighborhoodWalkscoreCard.vue'
import type {
  MobilityScore,
  PoiItem,
  CommuteDestination,
} from '@/components/blocks/neighborhood-walkscore-card/NeighborhoodWalkscoreCard.vue'
