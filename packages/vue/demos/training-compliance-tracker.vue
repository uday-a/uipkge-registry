...
import TrainingComplianceTracker from '@/components/blocks/training-compliance-tracker/TrainingComplianceTracker.vue'
</script>
...
<template>
  ...
  >
    <TrainingComplianceTracker default-filter="security" />
  </Story>
  ...
  >
    <TrainingComplianceTracker default-filter="governance" />
  </Story>
</template>
