...
<template>
  ...
  >
    <ScatterChart :data="bubble" x-field="x" y-field="y" size-field="size" height="320" />
  </Story>
  ...
  >
    <ScatterChart :data="categorical" x-field="x" y-field="y" category-field="category" height="320" />
  </Story>
  ...
  >
    <ScatterChart :data="basic" x-field="x" y-field="y" :option="trendLineOption" height="320" />
  </Story>
