...
import { ChordChart } from '@/components/ui/charts'
...
<template>
  <Story title="Service traffic" description="Weighted ribbons; hover a node to isolate its flows.">
    <ChordChart :nodes="nodes" :links="links" height="380" />
  </Story>

  <Story title="Team handoffs" description="Same shape for people and process flows.">
    <ChordChart
