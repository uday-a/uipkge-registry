...
import ComplianceSoc2Readiness from '@/components/blocks/compliance-soc2-readiness/ComplianceSoc2Readiness.vue'
</script>
...
<template>
  ...
  >
    <ComplianceSoc2Readiness default-framework="iso27001" />
  </Story>
  ...
  >
    <ComplianceSoc2Readiness default-framework="hipaa" />
  </Story>
  ...
  >
    <ComplianceSoc2Readiness default-framework="gdpr" />
  </Story>
</template>
