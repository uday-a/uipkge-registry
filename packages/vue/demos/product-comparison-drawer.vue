...
import ProductComparisonDrawer, {
  DEFAULT_COMPARISON_PRODUCTS,
} from '@/components/blocks/product-comparison-drawer/ProductComparisonDrawer.vue'
...
<template>
  ...
  >
    <ProductComparisonDrawer mode="expanded" :default-highlight-diffs="true" />
  </Story>
