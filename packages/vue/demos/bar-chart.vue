...
<template>
  ...
  >
    <BarChart :data="sales" x-field="category" y-field="value" height="280" />
  </Story>
  ...
  >
    <BarChart :data="sales" x-field="category" y-field="value" :option="horizontalOption" height="280" />
  </Story>

  <Story title="Grouped" description="Pass an array to y-field to render side-by-side groups. Legend auto-appears.">
    <BarChart :data="grouped" x-field="quarter" :y-field="['north', 'south', 'east', 'west']" height="320" />
  </Story>
  ...
  >
    <BarChart :data="cashflow" x-field="week" y-field="net" :option="negativeOption" height="280" />
  </Story>

  <Story title="Value labels" description="Exact numbers on top of every bar for glanceable decks.">
    <BarChart :data="sales" x-field="category" y-field="value" :value-labels="true" height="300" />
  </Story>
