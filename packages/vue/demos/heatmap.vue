...
<template>
  ...
  >
    <Heatmap :data="usageData" :x-labels="xLabels" :y-labels="yLabels" height="320" />
  </Story>
  ...
  >
    <Heatmap :data="sparse" :x-labels="xLabels" :y-labels="yLabels" :option="gapsOption" height="320" />
  </Story>
  ...
  >
    <Heatmap :data="usageData" :x-labels="xLabels" :y-labels="yLabels" :option="tealRampOption" height="320" />
  </Story>
  ...
  >
    <Heatmap :data="usageData" :x-labels="xLabels" :y-labels="yLabels" :option="orangeRampOption" height="320" />
  </Story>
  ...
  >
    <Heatmap :data="loadData" :x-labels="weekLabels" :y-labels="laneLabels" :min="60" :max="100" height="300" />
  </Story>
</template>
