...
<template>
  ...
  <Story title="Steps" description="Skip values with hour, minute, and second steps.">
    <div class="max-w-xs space-y-2">
      ...
      <TimePicker v-model="stepValue" :hour-step="2" :minute-step="15" :second-step="10" format="HH:mm:ss" />
      <p class="text-muted-foreground text-xs">
  ...
  <Story title="Status" description="Error and warning validation states.">
    <div class="flex max-w-xs flex-col gap-3">
      <TimePicker v-model="errorValue" status="error" placeholder="Error state" />
      <TimePicker v-model="warningValue" status="warning" placeholder="Warning state" />
    </div>
  </Story>
  ...
  <Story title="Allow Clear" description="Click the X to clear the selected time.">
    <div class="flex max-w-xs flex-col gap-3">
      <TimePicker v-model="clearableValue" allow-clear placeholder="Clearable" />
      <TimePicker v-model="nonClearableValue" :allow-clear="false" placeholder="Not clearable" />
    </div>
  </Story>
