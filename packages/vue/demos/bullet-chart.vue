...
const single = [{ label: 'Quota', actual: 68, target: 80, ranges: [40, 65, 100] as [number, number, number] }]
</script>
...
<template>
  ...
  <Story title="Single bullet" description="One row works as a compact quota tile.">
    <BulletChart :data="single" height="140" />
  </Story>
</template>
