...
import SecretsRotationScheduler from '@/components/blocks/secrets-rotation-scheduler/SecretsRotationScheduler.vue'
</script>
      ...
      :initial-secrets="[
        {
          ...
          lastLogSnippet:
            'Manual intervention required. Database cluster connection pool lacks dual-auth shadow accounts.',
        },
        {
          id: 'sec-alert-2',
