...
import SeoAuditChecklist from '@/components/blocks/seo-audit-checklist/SeoAuditChecklist.vue'
import type { SeoCategory } from '@/components/blocks/seo-audit-checklist/SeoAuditChecklist.vue'
...
<template>
  ...
  >
    <SeoAuditChecklist
      ...
      :score="88"
      last-audited="Audit completed in 520ms · Live crawl"
      title-tag="Minimalist Mechanical Keyboard Pro | TechStore Global"
      meta-description="Buy the Minimalist Mechanical Keyboard Pro with hot-swappable switches, wireless Bluetooth 5.2, and CNC aluminum chassis. Free shipping on orders $99+."
      h1-tag="Minimalist Mechanical Keyboard Pro"
  ...
  >
    <SeoAuditChecklist
      ...
      :score="98"
      last-audited="Audit completed in 410ms · Verified"
      title-tag="Migrating to Tailwind CSS v4 and OKLCH Tokens (2026 Guide)"
      meta-description="Learn how to upgrade your UI library to Tailwind CSS v4 with OKLCH dynamic color palettes, @theme inline directives, and zero-config CSS-first architecture."
      h1-tag="Complete Guide: Migrating to Tailwind CSS v4"
  ...
  >
    <SeoAuditChecklist
      ...
      :score="64"
      last-audited="Audit completed in 890ms · 4 Critical Issues"
      title-tag="Welcome to Our New Website - We Build Software and Digital Experiences for Enterprise Clients Worldwide"
      meta-description=""
      h1-tag="Multiple H1 Headings Detected"
