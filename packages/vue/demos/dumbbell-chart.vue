...
const ratings = [
  { label: "Speed", a: 3.1, b: 4.4 },
  { label: "Support", a: 3.8, b: 4.1 },
  { label: "Pricing", a: 4.0, b: 3.6 },
];
</script>
...
<template>
  ...
  <Story
    ...
    description="Custom series names per comparison."
  >
    <DumbbellChart :data="ratings" :names="['2024', '2025']" height="260" />
  </Story>
</template>
