  ...
  >
    <div class="space-y-2.5">
      <Card v-for="e in auditEvents" :key="e.id">
        <CardContent
          class="flex flex-col gap-2 py-3.5 sm:flex-row sm:items-center sm:justify-between"
        >
          <div class="space-y-1">
            ...
            <p class="text-muted-foreground text-xs">
              Target:
              <span class="text-foreground font-mono">{{ e.target }}</span> ·
              Actor: {{ e.actor }}
            </p>
          </div>
          <RelativeTime
  ...
  >
    <Card class="max-w-2xl">
      <CardHeader class="pb-3">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-2">
            ...
            <CardTitle class="text-sm font-semibold"
              >v2.4.0 Global Deployment</CardTitle
            >
          </div>
        ...
        <CardDescription
          >Target release scheduled in 3 hours 30 minutes.</CardDescription
        >
      </CardHeader>
      <CardContent class="divide-y p-0">
        <div class="flex items-center justify-between px-6 py-2.5 text-sm">
          <span class="text-muted-foreground"
            >Universal Coordinated Time (UTC)</span
          >
          <RelativeTime
            :date="globalRelease"
            :now="now"
