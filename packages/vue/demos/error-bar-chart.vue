...
import { ErrorBarChart } from "@/components/ui/charts";
...
<template>
  ...
  <Story
    ...
    description="Same lanes, tighter spreads off-season."
  >
    <ErrorBarChart
      :data="[
        { category: 'PVG–LAX', value: 3.9, low: 3.7, high: 4.1 },
        { category: 'SIN–HKG', value: 2.2, low: 2.0, high: 2.4 },
      ]"
      height="260"
    />
  </Story>
