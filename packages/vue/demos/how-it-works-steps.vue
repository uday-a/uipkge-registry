...
import HowItWorksSteps from '@/components/blocks/how-it-works-steps/HowItWorksSteps.vue'
// HowItWorksSteps is the block file the user installs. Open
// `components/blocks/HowItWorksSteps.vue` after install to edit the `steps`
