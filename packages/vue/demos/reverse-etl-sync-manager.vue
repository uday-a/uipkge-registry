...
import ReverseEtlSyncManager from '@/components/blocks/reverse-etl-sync-manager/ReverseEtlSyncManager.vue'
import type {
  FieldMapping,
  ReverseEtlMetrics,
  SyncRunRecord,
} from '@/components/blocks/reverse-etl-sync-manager/ReverseEtlSyncManager.vue'
...
<template>
  ...
  >
    <ReverseEtlSyncManager :initial-metrics="highVolumeMetrics" />
  </Story>
  ...
  >
    <ReverseEtlSyncManager :initial-mappings="customMappings" />
  </Story>
  ...
  >
    <ReverseEtlSyncManager :initial-runs="recentHistoryWithRetries" />
  </Story>
</template>
