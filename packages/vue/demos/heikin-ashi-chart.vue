...
import { HeikinAshiChart } from '@/components/ui/charts'
...
<template>
  <Story title="TPEB spot trend" description="Averaged candles smear the weekly chop into one clean uptrend into peak.">
    <HeikinAshiChart :data="tpeb" height="340" />
  </Story>

  <Story title="With zoom" description="Slider plus inside-zoom for long rate histories.">
    <HeikinAshiChart :data="tpeb" :zoom="true" height="340" />
  </Story>
</template>
