...
import HeaderAnnouncementStack from '@/components/blocks/header-announcement-stack/HeaderAnnouncementStack.vue'
// HeaderAnnouncementStack is the block file the user installs. Open
// `components/blocks/HeaderAnnouncementStack.vue` after install to change the
