...
import NotificationCenter from '@/components/blocks/notification-center/NotificationCenter.vue'
...
<template>
  ...
  <Story title="Mentions filter" description="The Mentions tab only shows mention-category rows.">
    <div>
      <p class="text-muted-foreground mb-2 text-xs">Click the Mentions tab to see the filter in action.</p>
      <NotificationCenter />
    </div>
  </Story>
  ...
  <Story title="Empty unread" description="Unread tab after clearing everything.">
    <div>
      <p class="text-muted-foreground mb-2 text-xs">Switch to the Unread tab — every row is already read.</p>
      <NotificationCenter
        :notifications="[
          {
            id: 'e1',
  ...
  <Story title="Many rows" description="Twelve items keep their grouping and stay scannable.">
    <NotificationCenter :notifications="manyNotifications" />
  </Story>
