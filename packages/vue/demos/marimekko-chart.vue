...
import { MarimekkoChart } from "@/components/ui/charts";
...
<template>
  ...
  <Story title="Two regions" description="Narrower view for quarter reviews.">
    <MarimekkoChart :columns="regions.slice(0, 2)" height="320" />
  </Story>
</template>
