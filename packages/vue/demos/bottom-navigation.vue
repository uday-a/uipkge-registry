...
import { ref } from 'vue'
import { Bell, Heart, Home, Inbox, Menu, Search, Settings, ShoppingCart, User } from 'lucide-vue-next'
import { BottomNavigation, type BottomNavItem } from '@/components/ui/bottom-navigation'
...
<template>
  ...
  >
    <div class="border-border mx-auto w-full max-w-sm overflow-hidden rounded-2xl border shadow-sm">
      ...
      <BottomNavigation :items="shopItems" v-model="shopActive" :fixed="false" />
    </div>
  </Story>
  ...
  >
    <div class="border-border mx-auto w-full max-w-sm overflow-hidden rounded-2xl border shadow-sm">
      ...
      <BottomNavigation :items="items" v-model="active" :fixed="false" active-color="text-violet-600" />
    </div>
  </Story>
  ...
  >
    <div class="grid max-w-md gap-4 sm:grid-cols-2">
      ...
      <div class="border-border overflow-hidden rounded-2xl border">
        ...
        <BottomNavigation :items="items" v-model="active" :fixed="false" :show-indicator="false" />
      </div>
    </div>
  </Story>
