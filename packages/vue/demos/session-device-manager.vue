...
import SessionDeviceManager from '@/components/blocks/session-device-manager/SessionDeviceManager.vue'
import type { SessionDevice } from '@/components/blocks/session-device-manager/SessionDeviceManager.vue'
...
<template>
  ...
  >
    <SessionDeviceManager :initial-show-suspicious-alert="false" />
  </Story>
  ...
  >
    <SessionDeviceManager :initial-other-sessions="[]" :initial-show-suspicious-alert="false" />
  </Story>
  ...
  >
    <SessionDeviceManager :initial-other-sessions="customMobileCliSessions" :initial-show-suspicious-alert="false" />
  </Story>
</template>
