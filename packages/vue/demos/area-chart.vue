...
<template>
  <Story title="Basic area" description="Single-series filled area chart with smooth interpolation.">
    <AreaChart :data="monthlyRevenue" x-field="month" y-field="revenue" height="280" />
  </Story>
  ...
  >
    <AreaChart :data="multiSeries" x-field="month" :y-field="['desktop', 'mobile', 'tablet']" height="300" />
  </Story>
  ...
  >
    <AreaChart :data="monthlyRevenue" x-field="month" y-field="revenue" :option="gradientOption" height="280" />
  </Story>
  ...
  >
    <AreaChart :data="monthlyRevenue" x-field="month" y-field="revenue" :option="steppedOption" height="280" />
  </Story>

  <Story title="Linear multi" description="Straight segments across all series via the curve prop.">
    <AreaChart
      :data="multiSeries"
      x-field="month"
      :y-field="['desktop', 'mobile', 'tablet']"
  ...
  <Story title="Markers on" description="Dots on every point for sparse series where each value matters.">
    <AreaChart :data="monthlyRevenue" x-field="month" y-field="revenue" :markers="true" height="280" />
  </Story>

  <Story title="Stacked prop" description="Same cumulative stack as the override above, now as a one-word prop.">
    <AreaChart
      :data="multiSeries"
      x-field="month"
      :y-field="['desktop', 'mobile', 'tablet']"
