...
<template>
  ...
  >
    <EventCalendar v-model="selectedDate" view="month" :events="demoEvents" :max-events-per-day="3" />
  </Story>
  ...
  >
    <EventCalendar v-model="selectedDate" view="week" :events="demoEvents" :first-interval="8" :interval-count="11" />
  </Story>
  ...
  >
    <EventCalendar v-model="selectedDate" view="day" :events="demoEvents" :first-interval="8" :interval-count="11" />
  </Story>
    ...
    <EventCalendar v-model="selectedDate" view="month" :events="demoEvents">
      <template #event="{ event }">
        ...
        >
          ...
          <span v-if="event.location" class="ml-auto hidden text-[10px] opacity-75 sm:inline">
            {{ event.location }}
          </span>
        </div>
      </template>
