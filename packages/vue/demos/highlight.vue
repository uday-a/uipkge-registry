...
<template>
  <Story
    title="Default"
    description="Highlights all occurrences of a query string."
  >
  ...
  <Story
    ...
    description="Every match is wrapped, not just the first."
  >
  ...
  <Story
    ...
    description="Matches regardless of letter case."
  >
  ...
  <Story
    ...
    description="Only whole words are highlighted, not substrings."
  >
  ...
  <Story
    title="Regex query"
    description="Pass a RegExp to highlight a pattern."
  >
  ...
  <Story
    ...
    description="Cap the number of rendered highlights."
  >
    <Highlight text="a b a b a b a b" query="a" :max-highlights="3" />
  </Story>

  <Story
    title="Custom highlight class"
    description="Override the default highlight styling."
  >
    <Highlight
  ...
  <Story
    title="No query"
    description="When the query is empty, text renders unchanged."
  >
  ...
  <Story
    title="No matches"
    description="When nothing matches, text renders unchanged."
  >
  ...
  <Story
    ...
    description="Highlights work across line breaks."
  >
    <Highlight
      text="Line one has a fox.\nLine two has a dog.\nLine three has another fox."
      query="fox"
    />
  </Story>
