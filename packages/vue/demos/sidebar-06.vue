...
import Sidebar06 from '@/components/blocks/sidebar-06/Sidebar06.vue'
...
<template>
  ...
  >
    <div
      class="relative h-[640px] overflow-hidden rounded-lg border [&_.h-svh]:!h-full [&_[data-slot=sidebar-wrapper]]:!min-h-0"
