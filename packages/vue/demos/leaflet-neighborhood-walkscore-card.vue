...
import LeafletNeighborhoodWalkscoreCard from '@/components/blocks/leaflet-neighborhood-walkscore-card/LeafletNeighborhoodWalkscoreCard.vue'
import type {
  MobilityScore,
  PoiItem,
  CommuteDestination,
} from '@/components/blocks/leaflet-neighborhood-walkscore-card/LeafletNeighborhoodWalkscoreCard.vue'
...
<template>
  <Story
    ...
    description="Comprehensive real estate neighborhood scorecard on free OpenStreetMap/Esri tiles — no API key — showcasing Walk Score (94/100 Walker's Paradise), Transit Score (82/100), Bike Score (88/100), categorized POIs with interactive filters, and commute duration comparisons."
  >
    <LeafletNeighborhoodWalkscoreCard />
  </Story>
  ...
  >
    <LeafletNeighborhoodWalkscoreCard
      ...
      city="Seattle"
      zip-code="98101"
      :walk-score="seattleWalkScore"
      :transit-score="seattleTransitScore"
      :bike-score="seattleBikeScore"
      :pois="seattlePois"
  ...
  >
    <LeafletNeighborhoodWalkscoreCard
      ...
      city="Austin"
      zip-code="78749"
      :walk-score="austinWalkScore"
      :transit-score="austinTransitScore"
      :bike-score="austinBikeScore"
    />
  </Story>
</template>
