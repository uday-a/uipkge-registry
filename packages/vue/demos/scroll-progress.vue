...
<template>
  <div class="space-y-4">
    ...
    >
      <div class="space-y-3">
        ...
        <p class="text-muted-foreground text-sm leading-relaxed">
          The bar sits at the very top edge of the viewport. Multiple fixed
          instances on one demo page stack into lanes, so each story below
          offsets itself a little to stay visible.
        </p>
      </div>
    </Story>
    ...
    >
      <ScrollProgress
        color="linear-gradient(90deg, var(--chart-1), var(--chart-3))"
        class="top-6"
      />
    </Story>
    ...
    <Story
      ...
      description="var(--destructive) suits warnings and time-boxed reading flows."
    >
    ...
    >
      <div class="space-y-3">
        ...
        <p class="text-muted-foreground text-sm leading-relaxed">
          Raw tracking updates state directly in the scroll handler — no
          animation frame loop is ever started.
        </p>
      </div>
    </Story>
    ...
    <div class="space-y-4 py-6">
      <p
        v-for="(para, i) in filler.slice(0, 4)"
        :key="i"
      ...
      <article class="space-y-3">
        ...
        <header class="space-y-1">
          <h3 class="text-lg font-semibold">
            Designing motion that respects attention
          </h3>
        ...
        <p class="text-muted-foreground text-sm leading-relaxed">
          Progress indicators earn their place by being glanceable and
          forgettable at once. This composition keeps the chrome minimal: a
          title, a meta row, and three pixels of state.
        </p>
        <p class="text-muted-foreground text-sm leading-relaxed">
          {{ filler[4] }}
        </p>
    ...
    >
      <div class="space-y-3">
        ...
        />
        <p class="text-muted-foreground text-sm leading-relaxed">
          Scroll past the threshold and the back-top button fades in at the
          bottom-right corner.
        </p>
        <BackTop />
      </div>
    ...
    >
      <div class="relative">
        ...
        <div class="space-y-3 p-4">
          <p class="text-muted-foreground text-sm leading-relaxed">
            Keep scrolling — the header sticks to the viewport top while the
            progress bar paints over its top edge.
          </p>
          <p class="text-muted-foreground text-sm leading-relaxed">
            {{ filler[6] }}
          </p>
    ...
    <div class="h-96 space-y-4">
      <p
        v-for="(para, i) in filler.slice(5)"
        :key="i"
        class="text-muted-foreground text-sm leading-relaxed"
      >
        {{ para }}
