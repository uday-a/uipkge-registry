    ...
    <div class="space-y-4">
      <div class="flex flex-wrap items-center gap-2 text-xs">
        ...
        >
          ...
          />
          <span class="text-foreground font-medium">Active Corridors:</span> 7
          Links
        </div>
        <div
          class="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1"
        >
          <span class="text-foreground font-medium">Global Bandwidth:</span>
          26.2 Tbps
        </div>
        <div
          class="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1"
    ...
    <div class="space-y-4">
      <div class="flex flex-wrap items-center gap-2 text-xs">
        <div
          class="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1"
        >
          <span class="text-foreground font-medium">Sortation Hubs:</span> 7
          Facilities
        </div>
        <div
          class="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1"
        >
          <span class="text-foreground font-medium">Volume:</span> 624,000
          pkgs/hr
        </div>
        <div
          class="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1"
    ...
    <div class="space-y-4">
      <div class="flex flex-wrap items-center gap-2 text-xs">
        ...
        >
          ...
          <span class="text-foreground font-medium">WAF Status:</span> Automated
          Defense Active
        </div>
        <div
          class="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1"
        >
          <span class="text-foreground font-medium">Peak Ingress:</span> 665
          Gbps
        </div>
        <div
          class="border-border bg-card text-muted-foreground flex items-center gap-1.5 rounded-md border px-2.5 py-1"
        >
          <span class="text-foreground font-medium">Scrubbing Efficiency:</span>
          99.85%
        </div>
      </div>
