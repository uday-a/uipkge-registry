...
import McpServerRegistryManager from '@/components/blocks/mcp-server-registry-manager/McpServerRegistryManager.vue'
</script>
...
<template>
  ...
  >
    <McpServerRegistryManager initial-transport-filter="sse" />
  </Story>
  ...
  >
    <McpServerRegistryManager initial-selected-tool-name="query_docs" :initial-drawer-open="true" />
  </Story>
  ...
  >
    <McpServerRegistryManager :initial-handshake-alert="true" />
  </Story>
  ...
  >
    <McpServerRegistryManager initial-search="postgres" />
  </Story>
  ...
  >
    <McpServerRegistryManager :initial-install-dialog-open="true" />
  </Story>
  ...
  >
    <McpServerRegistryManager :initial-servers="[]" />
  </Story>
</template>
