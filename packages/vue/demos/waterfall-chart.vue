...
const pnl = [
  ...
  { label: "Discounts", value: -4200 },
  { label: "Returns", value: -1800 },
...
<template>
  ...
  >
    <WaterfallChart :data="noTotal" :show-total="false" height="280" />
  </Story>

  <Story
    title="P&L bridge"
    description="Zero deltas render as flat steps — useful for subtotal rows."
  >
    <WaterfallChart :data="pnl" height="300" />
  </Story>

  <Story
    title="Compact"
    description="Shorter frame for dashboard tiles. Labels stay on top."
  >
