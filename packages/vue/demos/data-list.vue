...
import { Check, Shield, Zap } from 'lucide-vue-next'
</script>
  ...
  >
    <Card class="max-w-3xl">
      <div class="grid gap-x-8 gap-y-3 p-6 sm:grid-cols-3">
        <DataListItem class="border-0 py-1">
    ...
    <Card class="max-w-md">
      <DataList class="p-6">
        ...
        <DataListItem>
          ...
          <Badge class="bg-emerald-500/10 text-emerald-700 dark:text-emerald-400">Enterprise</Badge>
        </DataListItem>
        <DataListItem>
          <span class="text-sm font-medium">SSO</span>
          <Badge class="bg-sky-500/10 text-sky-700 dark:text-sky-400">SAML</Badge>
        </DataListItem>
      </DataList>
    </Card>
  </Story>
