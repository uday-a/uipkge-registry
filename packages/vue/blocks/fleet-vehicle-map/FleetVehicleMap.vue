...
export interface FleetVehicleMapProps {
...
const props = withDefaults(defineProps<FleetVehicleMapProps>(), {
  accessToken: '',
})
...
<template>
  <div data-slot="fleet-vehicle-map" :class="cn('flex h-full min-h-0 flex-col gap-4', props.class)">
