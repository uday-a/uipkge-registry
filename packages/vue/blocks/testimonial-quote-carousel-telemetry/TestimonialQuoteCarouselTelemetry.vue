      ...
      <div class="mx-auto max-w-3xl space-y-4 text-center">
        ...
        <div class="flex flex-wrap items-center justify-center gap-2 pt-2">
          <button
            ...
            :key="study.id"
            type="button"
            class="flex items-center gap-1.5 rounded-lg border px-3.5 py-1.5 font-mono text-xs transition-all"
            :class="
              activeIndex === idx
        ...
        <div class="grid grid-cols-1 items-center gap-8 lg:grid-cols-12">
          ...
          <div class="bg-muted/40 border-border space-y-6 rounded-2xl border p-6 lg:col-span-5">
            <div class="border-border flex items-center justify-between border-b pb-3">
              ...
              <Badge variant="outline" class="border-emerald-500/20 font-mono text-xs text-emerald-500">
                Post-Audit
              </Badge>
            </div>
            ...
            <div class="grid grid-cols-1 gap-3">
              ...
              >
                <div>
                  ...
                  <div class="text-xs font-semibold text-emerald-600 dark:text-emerald-400">{{ kpi.delta }}</div>
                </div>
