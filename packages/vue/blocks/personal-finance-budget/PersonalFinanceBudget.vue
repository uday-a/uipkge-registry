  ...
  <div data-slot="personal-finance-budget" :class="cn('mx-auto w-full max-w-6xl space-y-6', props.class)">
    ...
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
      <div class="space-y-1.5">
        ...
        <div class="flex flex-wrap items-center gap-2 pt-0.5">
          <div
            class="inline-flex items-center gap-1.5 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-0.5 text-xs font-medium text-emerald-600 dark:text-emerald-400"
          >
      ...
      <Card class="flex flex-col justify-between shadow-xs">
        ...
        <CardContent class="space-y-2">
          ...
          <div class="border-border/60 text-muted-foreground flex items-center justify-between border-t pt-2 text-xs">
            ...
            <span class="font-semibold text-emerald-600 tabular-nums dark:text-emerald-400">$0.00</span>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent class="space-y-2">
          <div>
            ...
            <div class="mt-2 space-y-1">
              <Progress :model-value="80.5" class="h-2 [&_[data-slot=progress-indicator]]:bg-amber-500" />
            </div>
          </div>
          <div class="border-border/60 text-muted-foreground flex items-center justify-between border-t pt-2 text-xs">
      ...
      <Card class="flex flex-col justify-between shadow-xs">
        ...
        <CardContent class="space-y-2">
          <div>
            ...
            <div class="mt-2 space-y-1">
              <Progress :model-value="89.3" class="h-2 [&_[data-slot=progress-indicator]]:bg-emerald-500" />
            </div>
          </div>
          <div class="border-border/60 text-muted-foreground flex items-center justify-between border-t pt-2 text-xs">
            <span>Funded to Date</span>
            <span class="font-semibold text-emerald-600 tabular-nums dark:text-emerald-400">$1,483.00 (89.3%)</span>
          </div>
        </CardContent>
      </Card>
    ...
    <Card class="bg-muted/20 border-border p-4 shadow-xs">
      <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-start gap-3">
          <div
            class="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-lg border border-emerald-500/20 bg-emerald-500/10 text-emerald-600 shadow-xs dark:text-emerald-400"
            aria-hidden="true"
          >
