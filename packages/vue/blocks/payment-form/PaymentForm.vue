...
<template>
  <div
    ...
    class="bg-card text-card-foreground mx-auto w-full max-w-md rounded-xl border p-6 shadow-sm"
  >
    ...
    <div v-if="showWallets && walletList.length" class="mb-4 space-y-3">
      ...
      <div class="flex items-center gap-3">
        ...
        <span class="text-muted-foreground text-xs tracking-widest uppercase">or pay with card</span>
        <div class="bg-border h-px flex-1" />
      </div>
    </div>
