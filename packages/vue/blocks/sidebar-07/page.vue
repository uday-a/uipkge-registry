...
// Demo page wired by `npx shadcn-vue add @uipkge/sidebar-07`.
// Visit /sidebar-07-demo after install to see the block without
// editing your own pages. Free to edit or delete me.
import Sidebar07 from '../components/blocks/Sidebar07.vue'
  ...
  <SidebarProvider>
    ...
    <SidebarInset>
      <header class="border-border flex h-14 shrink-0 items-center gap-3 border-b px-4">
        ...
        <h1 class="text-sm font-semibold">sidebar-07 demo</h1>
      </header>
