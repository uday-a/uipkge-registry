      ...
      <CardContent class="p-6">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div class="flex flex-wrap items-center gap-3">
            <div
              class="flex min-w-0 items-center gap-2 rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-3.5 py-2 text-emerald-800 shadow-xs dark:text-emerald-200"
            >
      ...
      <CardHeader class="pb-4">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div class="flex flex-wrap items-center gap-2 pt-1 text-xs sm:pt-0">
            ...
            <div
              class="flex items-center gap-1 rounded-md border border-emerald-500/20 bg-emerald-500/10 px-2 py-0.5 text-emerald-700 dark:text-emerald-300"
            >
              <span class="size-1.5 rounded-full bg-emerald-500" />
              <span class="font-medium">Favorable (≥80%)</span>
            </div>
            <div
              class="flex items-center gap-1 rounded-md border border-amber-500/20 bg-amber-500/10 px-2 py-0.5 text-amber-700 dark:text-amber-300"
            >
              <span class="size-1.5 rounded-full bg-amber-500" />
              <span class="font-medium">Moderate (70-79%)</span>
            </div>
            <div
              class="flex items-center gap-1 rounded-md border border-rose-500/20 bg-rose-500/10 px-2 py-0.5 text-rose-700 dark:text-rose-300"
            >
              ...
              <TableRow v-for="dept in departments" :key="dept.name" class="hover:bg-muted/30">
                ...
                <TableCell class="py-3.5 text-right">
                  <div class="flex flex-col items-end gap-1">
                    <div
                      class="inline-flex items-center gap-1.5 rounded-md border border-emerald-500/30 bg-emerald-500/10 px-2.5 py-1 text-xs font-bold text-emerald-700 tabular-nums dark:text-emerald-300"
                    >
        ...
        <CardContent class="space-y-4">
          ...
          >
            <div class="flex flex-wrap items-start justify-between gap-2">
              ...
              <div
                class="flex shrink-0 items-center gap-1 rounded-md border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-1 text-xs font-bold text-emerald-700 tabular-nums dark:text-emerald-300"
              >
        ...
        <CardContent class="space-y-4">
          ...
          >
            <div class="flex flex-wrap items-start justify-between gap-2">
              ...
              <div
                class="flex shrink-0 items-center gap-1 rounded-md border border-amber-500/20 bg-amber-500/10 px-2.5 py-1 text-xs font-bold text-amber-700 tabular-nums dark:text-amber-300"
              >
