    ...
    <section v-if="filteredCategories.length > 0" class="space-y-4">
      ...
      <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <Card
          ...
          :key="category.id"
          class="group/card hover:border-ring/50 relative flex flex-col justify-between overflow-hidden transition-all duration-200 hover:shadow-sm"
        >
    ...
    <section v-if="filteredArticles.length > 0" class="space-y-4">
      ...
      <div class="grid gap-4 md:grid-cols-2">
        <Card
          ...
          :key="article.id"
          class="group/article hover:border-ring/50 relative flex flex-col justify-between p-5 transition-all duration-200 hover:shadow-sm"
        >
