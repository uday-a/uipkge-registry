          ...
          <div class="flex flex-wrap items-center justify-between gap-2">
            <div class="flex min-w-0 items-center gap-2">
              <div
                ...
                aria-hidden="true"
              >
                <Coins class="size-4 text-sky-500" />
              </div>
        ...
        <CardContent class="space-y-3 pt-1">
          <div>
            ...
            <Progress
              ...
              class="h-1.5 w-full [&_[data-slot=progress-indicator]]:bg-sky-500"
            />
          </div>
        ...
        <CardContent class="space-y-3 pt-1">
          <div>
            ...
            <Progress
              ...
              class="h-1.5 w-full [&_[data-slot=progress-indicator]]:bg-indigo-500"
            />
          </div>
        ...
        <div class="bg-muted/40 border-border/80 hidden rounded-lg border p-3 md:block">
          <div class="flex items-center justify-between text-xs font-medium">
            ...
            <div class="flex items-center gap-4 text-xs">
              ...
              <div class="flex items-center gap-1.5">
                <span class="size-2.5 rounded-full bg-emerald-500 ring-1 ring-emerald-500/50" />
                ...
                >
                  ...
                  <TableCell class="py-4 align-middle">
                    <div class="space-y-2 py-1">
                      ...
                      <div class="bg-muted border-border/80 relative h-4 w-full overflow-hidden rounded-full border">
                        ...
                        <div
                          class="border-background absolute top-1/2 size-3 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 bg-emerald-500 shadow-xs ring-2 ring-emerald-500/40"
                  ...
                  <TableCell class="py-4 align-middle">
                    <div class="space-y-0.5">
                      ...
                      <p class="text-xs font-medium text-emerald-600 tabular-nums dark:text-emerald-400">
      ...
      <CardContent class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div class="bg-muted/40 border-border/80 space-y-1 rounded-lg border p-3.5">
            <div class="text-muted-foreground flex items-center justify-between text-xs">
              ...
              <Badge wrap variant="outline" class="text-xs font-semibold text-emerald-600 dark:text-emerald-400">
                100% Target
              </Badge>
            </div>
        ...
        <div class="bg-muted/30 border-border space-y-3 rounded-lg border p-4">
          <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
            ...
            <span class="text-muted-foreground text-xs">
              ...
              <strong class="font-semibold text-emerald-600 dark:text-emerald-400"
                >Certified Safe Harbor (0.2% Variance)</strong
              >
            </span>
          </div>
          ...
          <div class="bg-muted border-border/80 relative h-3.5 w-full overflow-hidden rounded-full border">
            ...
            <div class="absolute inset-y-0 left-0 w-[30%] bg-amber-500/20" />
            <!-- Certified Equal Pay Zone (98-102%) -->
            <div class="absolute inset-y-0 left-[30%] w-[40%] bg-emerald-500/30" />
            <!-- Premium right zone (102-105%) -->
            <div class="absolute inset-y-0 right-0 w-[30%] bg-amber-500/20" />
            <!-- Exact Company Parity Pin (99.8% -> 48% of bar) -->
            <div
              class="border-background absolute top-1/2 size-3.5 -translate-y-1/2 rounded-full border-2 bg-emerald-500 shadow-xs ring-2 ring-emerald-500/50"
              style="left: 48%"
          ...
          <div class="text-muted-foreground flex items-center justify-between text-xs tabular-nums">
            ...
            <span class="font-bold text-emerald-600 dark:text-emerald-400">99.8% (Current Company Parity)</span>
