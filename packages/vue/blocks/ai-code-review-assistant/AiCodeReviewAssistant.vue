        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div class="space-y-2">
            ...
            <div class="text-muted-foreground flex flex-wrap items-center gap-2 text-xs sm:text-sm">
              ...
              <div class="flex items-center gap-1 font-mono text-xs">
                ...
                <span>8f2a49b</span>
                <span>·</span>
                <span class="font-medium text-emerald-600 dark:text-emerald-400">+142</span>
                <span class="font-medium text-rose-600 dark:text-rose-400">-68</span>
              </div>
            </div>
          </div>
          ...
          <div class="flex flex-wrap items-center gap-2.5">
            <Badge
              ...
              variant="success"
              class="gap-1.5 border-emerald-500/20 bg-emerald-500/10 px-3 py-1 text-xs font-semibold text-emerald-600 dark:text-emerald-400"
            >
            ...
            <Badge
              ...
              v-else
              variant="success"
              class="gap-1.5 border-emerald-500/30 bg-emerald-500/15 px-3 py-1 text-xs font-semibold text-emerald-700 dark:text-emerald-300"
            >
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <CardContent class="p-4 sm:p-5">
          ...
          <div class="mt-3">
            ...
            <p class="text-muted-foreground mt-1 text-xs">
              Clean Architecture · <span class="font-medium text-emerald-600 dark:text-emerald-400">+14 pts</span> vs
              baseline
            </p>
          </div>
      ...
      <Card class="border-border bg-card shadow-xs">
        <CardContent class="p-4 sm:p-5">
          ...
          <div class="mt-3">
            ...
            <p class="text-muted-foreground mt-1 text-xs">
              0 Vulnerabilities Detected · <span class="font-medium text-emerald-600 dark:text-emerald-400">Pass</span>
            </p>
          </div>
          <div class="mt-3 flex items-center gap-1.5 text-xs font-medium text-emerald-600 dark:text-emerald-400">
            <Check class="size-3.5" />
      ...
      <Card class="border-border bg-card shadow-xs">
        <CardContent class="p-4 sm:p-5">
          ...
          <div class="mt-3 flex items-center gap-1.5 text-xs font-medium text-amber-600 dark:text-amber-400">
      ...
      <Card class="border-border bg-card shadow-xs">
        <CardContent class="p-4 sm:p-5">
          <div class="flex items-center justify-between">
            ...
            <div
              class="flex size-8 items-center justify-center rounded-md bg-sky-500/10 text-sky-600 dark:text-sky-400"
            >
              <Layers class="size-4" />
            </div>
          </div>
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div class="flex items-center gap-2">
            <Button variant="outline" size="sm" class="h-8 gap-1.5 text-xs font-medium shadow-xs" @click="copyRawDiff">
              <Check v-if="copiedDiff" class="size-3.5 text-emerald-600 dark:text-emerald-400" />
          ...
          <TabsContent value="diff" class="space-y-4 focus-visible:outline-none">
            ...
            >
              <div class="text-muted-foreground flex items-center gap-2">
                ...
                <span>·</span>
                <span class="font-medium text-emerald-600 dark:text-emerald-400">+24 additions</span>
                <span>·</span>
                <span class="font-medium text-rose-600 dark:text-rose-400">-12 deletions</span>
              </div>
              ...
              <div class="max-w-[620px] min-w-full py-2">
                <template v-for="line in diffLines" :key="line.id">
                  ...
                  <div
                    ...
                    class="mx-4 my-3 rounded-lg border border-amber-500/40 bg-amber-500/[0.04] p-4 text-xs shadow-xs dark:border-amber-500/30 dark:bg-amber-950/[0.1]"
                  >
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      <div class="space-y-1.5">
                        <div class="flex flex-wrap items-center gap-2">
                          <div
                            class="flex size-6 items-center justify-center rounded-md bg-amber-500/20 text-amber-700 dark:text-amber-300"
                          >
                            <Bot class="size-3.5" />
                          </div>
                      ...
                      <div class="flex shrink-0 flex-wrap items-center gap-2 self-start sm:self-auto">
                        ...
                        >
                          <Check
                            v-if="appliedPatches.has('patch-1')"
                            class="size-3 text-emerald-600 dark:text-emerald-400"
                          />
                  ...
                  <div
                    ...
                    class="mx-4 my-3 rounded-lg border border-emerald-500/40 bg-emerald-500/[0.04] p-4 text-xs shadow-xs dark:border-emerald-500/30 dark:bg-emerald-950/[0.1]"
                  >
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      <div class="space-y-1.5">
                        <div class="flex flex-wrap items-center gap-2">
                          <div
                            class="flex size-6 items-center justify-center rounded-md bg-emerald-500/20 text-emerald-700 dark:text-emerald-300"
                          >
                            <ShieldCheck class="size-3.5" />
                          </div>
                      ...
                      <div class="flex shrink-0 flex-wrap items-center gap-2 self-start sm:self-auto">
                        ...
                        >
                          <Check
                            v-if="appliedPatches.has('patch-2')"
                            class="size-3 text-emerald-600 dark:text-emerald-400"
                          />
                          <Zap v-else class="size-3" />
                          <span>{{
          ...
          <TabsContent value="rules" class="space-y-4 focus-visible:outline-none">
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <div class="border-border bg-muted/20 space-y-2 rounded-lg border p-4">
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-2 text-sm font-semibold">
                    <Zap class="size-4 text-emerald-600 dark:text-emerald-400" />
              ...
              <div class="border-border bg-muted/20 space-y-2 rounded-lg border p-4">
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-2 text-sm font-semibold">
                    <Cpu class="size-4 text-emerald-600 dark:text-emerald-400" />
            ...
            <div class="border-border overflow-x-auto rounded-lg border">
              ...
              <div class="divide-border max-w-[480px] min-w-full divide-y text-xs">
                <div class="grid grid-cols-3 p-3 font-medium">
                  ...
                  <span class="font-bold text-emerald-600 dark:text-emerald-400">OKLCH Perceptual Engine</span>
                </div>
                <div class="grid grid-cols-3 p-3">
                  <span class="font-medium">Total Token CSS Bundle</span>
                  <span class="text-muted-foreground font-mono">14.8 KB</span>
                  <span class="font-mono font-bold text-emerald-600 dark:text-emerald-400">10.6 KB (-28.4%)</span>
                </div>
                <div class="grid grid-cols-3 p-3">
                  <span class="font-medium">DOM Custom Properties</span>
                  <span class="text-muted-foreground font-mono">64 variables</span>
                  <span class="font-mono font-bold text-emerald-600 dark:text-emerald-400">44 variables (-31.2%)</span>
                </div>
                <div class="grid grid-cols-3 p-3">
                  <span class="font-medium">Display P3 Wide Gamut</span>
                  <span class="text-rose-600 dark:text-rose-400">Clipping on 14 colors</span>
                  <span class="font-bold text-emerald-600 dark:text-emerald-400">100% P3 Coverage</span>
                </div>
                <div class="grid grid-cols-3 p-3">
                  <span class="font-medium">Perceptual Uniformity</span>
                  <span class="text-muted-foreground">Non-linear (HSL shift)</span>
                  <span class="font-bold text-emerald-600 dark:text-emerald-400">Mathematically Uniform (LCH)</span>
                </div>
              </div>
            </div>
          </TabsContent>
