...
<template>
  <section data-slot="logos-03" class="bg-muted/30 border-y">
    <div class="mx-auto max-w-6xl px-6 py-14">
      ...
      <div
        class="group relative space-y-5 overflow-hidden"
        style="
      ...
      >
        ...
        <div class="logos03-track logos03-left-32 flex w-max gap-12 will-change-transform">
          <div
            v-for="(logo, i) in [...ROW_1, ...ROW_1]"
            :key="`r1-${i}`"
        ...
        <div class="logos03-track logos03-right-26 flex w-max gap-12 will-change-transform">
          <div
            v-for="(logo, i) in [...ROW_2, ...ROW_2]"
            :key="`r2-${i}`"
            class="text-foreground/55 hover:text-foreground inline-flex shrink-0 items-center gap-2 transition-colors"
          >
            <svg viewBox="0 0 24 24" class="size-5 shrink-0" fill="currentColor" role="img" :aria-label="logo.label">
        ...
        <div class="logos03-track logos03-left-38 flex w-max gap-12 will-change-transform">
          <div
            v-for="(logo, i) in [...ROW_3, ...ROW_3]"
            :key="`r3-${i}`"
            class="text-foreground/55 hover:text-foreground inline-flex shrink-0 items-center gap-2 transition-colors"
          >
            <svg viewBox="0 0 24 24" class="size-5 shrink-0" fill="currentColor" role="img" :aria-label="logo.label">
...
.logos03-left-32 {
  animation: logos-marquee-left 32s linear infinite;
}
.logos03-right-26 {
  animation: logos-marquee-right 26s linear infinite;
}
.logos03-left-38 {
  animation: logos-marquee-left 38s linear infinite;
}
.group:hover .logos03-track {
