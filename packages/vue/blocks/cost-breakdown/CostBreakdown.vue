...
import { chartTextColor } from '@/components/ui/charts/useChartTheme'
...
<template>
  <div data-slot="cost-breakdown" class="space-y-6">
    <!-- Weekly trend (top) -->
    <section class="bg-card border-border rounded-lg border p-5">
      <div class="mb-3 flex items-baseline justify-between gap-4">
        <div>
          <h3 class="text-sm font-semibold tracking-tight">Cost per day</h3>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
      <section class="bg-card border-border rounded-lg border p-4 sm:p-5">
        <h3 class="text-sm font-semibold tracking-tight">Cost share by lane</h3>
      ...
      <section class="bg-card border-border rounded-lg border p-4 sm:p-5">
        <h3 class="text-sm font-semibold tracking-tight">Cost share by carrier</h3>
