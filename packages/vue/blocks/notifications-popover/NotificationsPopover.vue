...
<template>
  <Popover data-slot="notifications-popover" v-model:open="isOpen">
    ...
    <PopoverContent
      align="end"
      :side-offset="8"
      class="notification-panel w-96 overflow-hidden rounded-lg border p-0 shadow-xl"
    >
      <div class="flex items-center justify-between px-4 pt-4 pb-3">
        <div class="flex items-center gap-2.5">
          ...
          <Badge
            v-if="unreadCount > 0"
            class="bg-primary/15 text-primary hover:bg-primary/15 h-5 rounded-full px-1.5 text-[0.625rem] font-bold tabular-nums"
          >
            {{ unreadCount }}
          </Badge>
        </div>
        ...
        <div class="flex gap-0">
          ...
          >
            ...
            <span
              ...
              class="bg-primary absolute right-0 bottom-0 left-0 h-px rounded-t-full"
            />
          </button>
          <button
            :class="[
      ...
      <div class="notification-scroll max-h-[26.25rem] overflow-y-auto">
        <div
        ...
        <template v-else>
          <template v-if="groupedNotifications.today.length > 0">
            <div class="px-4 pt-3 pb-1">
              <span class="text-muted-foreground text-[0.625rem] font-semibold tracking-widest uppercase">Today</span>
            </div>
            <div
                ...
                <div class="min-w-0 flex-1">
                  <div class="flex items-start justify-between gap-2">
                    ...
                    <div class="flex shrink-0 items-center gap-1.5">
                      <span class="text-muted-foreground text-[0.625rem] whitespace-nowrap tabular-nums">
          ...
          <template v-if="groupedNotifications.earlier.length > 0">
            <div class="px-4 pt-3 pb-1">
              <span class="text-muted-foreground text-[0.625rem] font-semibold tracking-widest uppercase">Earlier</span>
            </div>
            <div
