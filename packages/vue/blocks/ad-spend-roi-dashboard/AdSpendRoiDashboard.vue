      ...
      <Card class="flex flex-col justify-between shadow-xs">
        <CardHeader class="pb-2">
          <div class="flex flex-wrap items-center justify-between gap-2">
            ...
            <Badge
              wrap
              variant="outline"
              class="gap-1 border-emerald-500/20 bg-emerald-500/10 text-xs font-medium text-emerald-600 tabular-nums dark:text-emerald-400"
            >
        ...
        <CardContent class="space-y-3">
          ...
          <div class="border-border/60 border-t pt-2 text-xs">
            ...
            <p class="mt-0.5 text-xs font-medium text-emerald-600 dark:text-emerald-400">11.8% below budget cap</p>
          </div>
        </CardContent>
      </Card>
          ...
          >
            <div class="flex items-start justify-between gap-2">
              ...
              <Badge
                wrap
                variant="outline"
                class="shrink-0 border-emerald-500/20 bg-emerald-500/10 text-xs font-bold text-emerald-600 tabular-nums dark:text-emerald-400"
              >
                {{ campaign.roas }} ROAS
              </Badge>
            </div>
            ...
            <div class="border-border/60 grid grid-cols-1 gap-2 border-t pt-2 text-xs sm:grid-cols-3">
              ...
              <div>
                ...
                <p class="font-semibold text-emerald-600 tabular-nums dark:text-emerald-400">{{ campaign.revenue }}</p>
              </div>
        ...
        <CardContent class="space-y-4">
          ...
          <div class="space-y-3 text-xs">
            <div class="space-y-1">
              ...
              <Progress :model-value="45.1" class="h-1.5 [&_[data-slot=progress-indicator]]:bg-blue-600" />
            </div>
            ...
            <div class="space-y-1">
              ...
              <Progress :model-value="30.8" class="h-1.5 [&_[data-slot=progress-indicator]]:bg-indigo-600" />
            </div>
            ...
            <div class="space-y-1">
              ...
              <Progress :model-value="15.3" class="h-1.5 [&_[data-slot=progress-indicator]]:bg-sky-600" />
            </div>
