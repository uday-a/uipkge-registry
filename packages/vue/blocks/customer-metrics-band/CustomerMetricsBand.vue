    ...
    <div class="mx-auto max-w-6xl space-y-12">
      ...
      >
        ...
        <div class="bg-background border-border flex shrink-0 items-center gap-1 rounded-xl border p-1">
          <button
            ...
            :key="c.id"
            type="button"
            class="rounded-lg px-3 py-1.5 font-mono text-xs transition-all"
            :class="
              activeCohort === c.id
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card
          ...
          :key="stat.id"
          class="border-border bg-card/90 flex cursor-pointer flex-col justify-between space-y-4 rounded-2xl p-5 shadow-sm transition-all hover:shadow-md"
      ...
      >
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <div class="border-border bg-background/50 space-y-1 rounded-xl border p-4">
            ...
            <p class="font-mono text-lg font-bold text-emerald-600 dark:text-emerald-400">
