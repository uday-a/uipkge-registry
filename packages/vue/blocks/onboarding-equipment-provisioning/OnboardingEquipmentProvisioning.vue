    ...
    <div class="border-border bg-card flex flex-col gap-4 rounded-xl border p-5 shadow-xs sm:p-6">
      <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div class="space-y-1.5">
          ...
          <div class="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs sm:text-sm">
            ...
            <span class="text-muted-foreground hidden sm:inline">&bull;</span>
            ...
            >
              EMP-88291
              <Check v-if="copiedEmpId" class="size-3 text-emerald-600 dark:text-emerald-400" aria-hidden="true" />
      ...
      <div class="grid grid-cols-2 gap-4 pt-1 sm:grid-cols-4">
        ...
        <div class="border-border/60 bg-muted/20 rounded-lg border p-3">
          ...
          <p class="text-xs font-medium text-emerald-700 dark:text-emerald-400">All Provisioned</p>
        </div>
                  ...
                  <div class="min-w-0 space-y-1">
                    ...
                    <div class="flex flex-wrap items-center gap-2 pt-1">
                      <Badge wrap variant="secondary" class="font-mono text-xs">
                        <ShieldCheck class="mr-1 size-3 text-emerald-600 dark:text-emerald-400" aria-hidden="true" />
        ...
        <CardContent class="space-y-3">
          ...
          >
            <div class="text-muted-foreground flex items-center gap-1.5">
              <Lock class="size-3.5 text-emerald-600 dark:text-emerald-400" aria-hidden="true" />
              <span>SOC 2 Type II &amp; FedRAMP High compliant hardware assignment</span>
            </div>
            <span class="font-medium text-emerald-700 dark:text-emerald-400">Enforced</span>
          </div>
        </CardContent>
            ...
            >
              <div class="space-y-1">
                <div class="flex items-start justify-between gap-1.5">
                  ...
                  <div
                    class="inline-flex items-center gap-1 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-1.5 py-0.5 text-xs font-medium text-emerald-700 dark:text-emerald-400"
                  >
      ...
      <CardContent class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div class="border-border bg-muted/20 space-y-1 rounded-lg border p-3.5">
            ...
            <p class="text-muted-foreground text-xs">Senior Staff Engineer &bull; Distributed Systems</p>
            <p class="text-muted-foreground text-xs">elena.rostova@acme.corp</p>
          </div>
